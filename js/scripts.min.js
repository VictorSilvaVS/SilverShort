...
!function(e, t) {
    ...
    function y(e, t, n) {
        var a, i, r = (n = n || m).createElement("script");
        if (r.text = e,
        t)
            for (a in g)
                (i = t[a] || t.getAttribute && t.getAttribute(a)) && r.setAttribute(a, i);
    ...
    x.extend = x.fn.extend = function() {
        var e, t, n, a, i, r, s = arguments[0] || {}, o = 1, l = arguments.length, d = !1;
        ...
        o--); o < l; o++)
            if (null != (e = arguments[o]))
                for (t in e)
                    a = e[t],
                    "__proto__" !== t && s !== a && (d && a && (x.isPlainObject(a) || (i = Array.isArray(a))) ? (n = s[t],
                    r = i && !Array.isArray(n) ? [] : i || x.isPlainObject(n) ? n : {},
                    i = !1,
                    s[t] = x.extend(d, r, a)) : void 0 !== a && (s[t] = a));
        return s
    }
    ,
    x.extend({
        ...
        isPlainObject: function(e) {
            var t, n;
            return !(!e || "[object Object]" !== d.call(e) || (t = a(e)) && ("function" != typeof (n = u.call(t, "constructor") && t.constructor) || c.call(n) !== p))
        },
        ...
        grep: function(e, t, n) {
            for (var a = [], i = 0, r = e.length, s = !n; i < r; i++)
    ...
    var T = function(e) {
        var t, n, a, i, r, s, o, l, d, u, c, p, f, h, v, m, g, y, b, w = "sizzle" + 1 * new Date, x = e.document, C = 0, T = 0, E = le(), S = le(), k = le(), M = le(), $ = function(e, t) {
            return e === t && (c = !0),
            0
        }, P = {}.hasOwnProperty, L = [], A = L.pop, z = L.push, D = L.push, N = L.slice, O = function(e, t) {
            for (var n = 0, a = e.length; n < a; n++)
                if (e[n] === t)
                    return n;
            return -1
        }, I = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", j = "[\\x20\\t\\r\\n\\f]", H = "(?:\\\\[\\da-fA-F]{1,6}" + j + "?|\\\\[^\\r\\n\\f]|[\\w-]|[^\0-\\x7f])+", B = "\\[" + j + "*(" + H + ")(?:" + j + "*([*^$|!~]?=)" + j + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + H + "))|)" + j + "*\\]", q = ":(" + H + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + B + ")*)|.*)\\)|)", R = new RegExp(j + "+","g"), F = new RegExp("^" + j + "+|((?:^|[^\\\\])(?:\\\\.)*)" + j + "+$","g"), _ = new RegExp("^" + j + "*," + j + "*"), G = new RegExp("^" + j + "*([>+~]|" + j + ")" + j + "*"), W = new RegExp(j + "|>"), X = new RegExp(q), V = new RegExp("^" + H + "$"), Y = {
            ID: new RegExp("^#(" + H + ")"),
            CLASS: new RegExp("^\\.(" + H + ")"),
            TAG: new RegExp("^(" + H + "|[*])"),
            ATTR: new RegExp("^" + B),
        ...
        }, U = /HTML$/i, K = /^(?:input|select|textarea|button)$/i, Q = /^h\d$/i, J = /^[^{]+\{\s*\[native \w/, Z = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, ee = /[+~]/, te = new RegExp("\\\\[\\da-fA-F]{1,6}" + j + "?|\\\\([^\\r\\n\\f])","g"), ne = function(e, t) {
            var n = "0x" + e.slice(1) - 65536;
            return t || (n < 0 ? String.fromCharCode(n + 65536) : String.fromCharCode(n >> 10 | 55296, 1023 & n | 56320))
        }, ae = /([\0-\x1f\x7f]|^-?\d)|^-$|[^\0-\x1f\x7f-\uFFFF\w-]/g, ie = function(e, t) {
        ...
        function oe(e, t, a, i) {
            var r, o, d, u, c, h, g, y = t && t.ownerDocument, x = t ? t.nodeType : 9;
            if (a = a || [],
            ...
            v)) {
                if (11 !== x && (c = Z.exec(e)))
                    if (r = c[1]) {
                        ...
                        if (c[2])
                            return D.apply(a, t.getElementsByTagName(e)),
                            a;
                        if ((r = c[3]) && n.getElementsByClassName && t.getElementsByClassName)
                            return D.apply(a, t.getElementsByClassName(r)),
                            a
                    }
                if (n.qsa && !M[e + " "] && (!m || !m.test(e)) && (1 !== x || "object" !== t.nodeName.toLowerCase())) {
                    ...
                    1 === x && (W.test(e) || G.test(e))) {
                        for ((y = ee.test(e) && ge(t.parentNode) || t) === t && n.scope || ((u = t.getAttribute("id")) ? u = u.replace(ae, ie) : t.setAttribute("id", u = w)),
                        o = (h = s(e)).length; o--; )
                            h[o] = (u ? "#" + u : ":scope") + " " + be(h[o]);
                        g = h.join(",")
                    }
                    try {
                        return D.apply(a, y.querySelectorAll(g)),
                        a
                    } catch (t) {
                        M(e, !0)
                    } finally {
        ...
        p = oe.setDocument = function(e) {
            ...
            v = !r(f),
            x != f && (i = f.defaultView) && i.top !== i && (i.addEventListener ? i.addEventListener("unload", re, !1) : i.attachEvent && i.attachEvent("onunload", re)),
            ...
            $ = t ? function(e, t) {
                ...
                return a || (1 & (a = (e.ownerDocument || e) == (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1) || !n.sortDetached && t.compareDocumentPosition(e) === a ? e == f || e.ownerDocument == x && b(x, e) ? -1 : t == f || t.ownerDocument == x && b(x, t) ? 1 : u ? O(u, e) - O(u, t) : 0 : 4 & a ? -1 : 1)
            }
            : function(e, t) {
                if (e === t)
                    return c = !0,
                    0;
                var n, a = 0, i = e.parentNode, r = t.parentNode, s = [e], o = [t];
                if (!i || !r)
                    return e == f ? -1 : t == f ? 1 : i ? -1 : r ? 1 : u ? O(u, e) - O(u, t) : 0;
                if (i === r)
                    return pe(e, t);
        ...
        oe.attr = function(e, t) {
            ...
            var i = a.attrHandle[t.toLowerCase()]
              , r = i && P.call(a.attrHandle, t.toLowerCase()) ? i(e, t, !v) : void 0;
        ...
        (a = oe.selectors = {
            ...
            preFilter: {
                ...
                PSEUDO: function(e) {
                    var t, n = !e[6] && e[2];
                    return Y.CHILD.test(e[0]) ? null : (e[3] ? e[2] = e[4] || e[5] || "" : n && X.test(n) && (t = s(n, !0)) && (t = n.indexOf(")", n.length - t) - n.length) && (e[0] = e[0].slice(0, t),
                    e[2] = n.slice(0, t)),
                    e.slice(0, 3))
                }
            },
            filter: {
                ...
                ATTR: function(e, t, n) {
                    return function(a) {
                        var i = oe.attr(a, e);
                        return null == i ? "!=" === t : !t || (i += "",
                        "=" === t ? i === n : "!=" === t ? i !== n : "^=" === t ? n && 0 === i.indexOf(n) : "*=" === t ? n && -1 < i.indexOf(n) : "$=" === t ? n && i.slice(-n.length) === n : "~=" === t ? -1 < (" " + i.replace(R, " ") + " ").indexOf(n) : "|=" === t && (i === n || i.slice(0, n.length + 1) === n + "-"))
                    }
                },
                CHILD: function(e, t, n, a, i) {
                    ...
                    : function(t, n, l) {
                        ...
                        if (m) {
                            ...
                            s && y) {
                                for (b = (f = (d = (u = (c = (p = m)[w] || (p[w] = {}))[p.uniqueID] || (c[p.uniqueID] = {}))[e] || [])[0] === C && d[1]) && d[2],
                                p = f && m.childNodes[f]; p = ++f && p && p[v] || (b = f = 0) || h.pop(); )
                                    if (1 === p.nodeType && ++b && p === t) {
                                        u[e] = [C, f, b];
                                        break
                                    }
                            } else if (y && (b = f = (d = (u = (c = (p = t)[w] || (p[w] = {}))[p.uniqueID] || (c[p.uniqueID] = {}))[e] || [])[0] === C && d[1]),
                            !1 === b)
                                for (; (p = ++f && p && p[v] || (b = f = 0) || h.pop()) && ((o ? p.nodeName.toLowerCase() !== g : 1 !== p.nodeType) || !++b || (y && ((u = (c = p[w] || (p[w] = {}))[p.uniqueID] || (c[p.uniqueID] = {}))[e] = [C, b]),
                                p !== t)); )
                                    ;
                ...
                PSEUDO: function(e, t) {
                    ...
                    return i[w] ? i(t) : 1 < i.length ? (n = [e, e, "", t],
                    a.setFilters.hasOwnProperty(e.toLowerCase()) ? de((function(e, n) {
            ...
            pseudos: {
                not: de((function(e) {
                    var t = []
                      , n = []
                      , a = o(e.replace(F, "$1"));
                    return a[w] ? de((function(e, t, n, i) {
        ...
        function we(e, t, n) {
            ...
            : function(t, n, l) {
                ...
                if (l) {
                    ...
                    for (; t = t[a]; )
                        if (1 === t.nodeType || s)
                            if (u = (c = t[w] || (t[w] = {}))[t.uniqueID] || (c[t.uniqueID] = {}),
                            i && i === t.nodeName.toLowerCase())
                                t = t[a] || t;
                            else {
                                if ((d = u[r]) && d[0] === C && d[1] === o)
                                    return p[2] = d[2];
                                if ((u[r] = p)[2] = e(t, n, l))
                                    return !0
                            }
        ...
        function Te(e, t, n, a, i, r) {
            ...
            i && !i[w] && (i = Te(i, r)),
            de((function(r, s, o, l) {
                var d, u, c, p = [], f = [], h = s.length, v = r || function(e, t, n) {
                    for (var a = 0, i = t.length; a < i; a++)
                        oe(e, t[a], n);
                    return n
                }(t || "*", o.nodeType ? [o] : o, []), m = !e || !r && t ? v : Ce(v, p, e, o, l), g = n ? i || (r ? e : h || a) ? [] : s : m;
                if (n && n(m, g, o, l),
                a)
                    for (d = Ce(g, f),
                    a(d, [], o, l),
                ...
                if (r) {
                    if (i || e) {
                        ...
                        for (u = g.length; u--; )
                            (c = g[u]) && -1 < (d = i ? O(r, c) : p[u]) && (r[d] = !(s[d] = c))
                    }
                } else
        ...
        function Ee(e) {
            for (var t, n, i, r = e.length, s = a.relative[e[0].type], o = s || a.relative[" "], l = s ? 1 : 0, u = we((function(e) {
                return e === t
            }
            ), o, !0), c = we((function(e) {
                return -1 < O(t, e)
                ...
                var i = !s && (a || n !== d) || ((t = n).nodeType ? u(e, n, a) : c(e, n, a));
                return t = null,
                i
            }
            ]; l < r; l++)
                if (n = a.relative[e[l].type])
                    p = [we(xe(p), n)];
                else {
                    if ((n = a.filter[e[l].type].apply(null, e[l].matches))[w]) {
                        for (i = ++l; i < r && !a.relative[e[i].type]; i++)
                            ;
                        return Te(1 < l && xe(p), 1 < l && be(e.slice(0, l - 1).concat({
                            value: " " === e[l - 2].type ? "*" : ""
                        })).replace(F, "$1"), n, l < i && Ee(e.slice(l, i)), i < r && Ee(e = e.slice(i)), i < r && be(e))
                    }
                    p.push(n)
                }
            return xe(p)
        ...
        s = oe.tokenize = function(e, t) {
            var n, i, r, s, o, l, d, u = S[e + " "];
            if (u)
                return t ? 0 : u.slice(0);
            for (o = e,
            l = [],
            d = a.preFilter; o; ) {
                for (s in n && !(i = _.exec(o)) || (i && (o = o.slice(i[0].length) || o),
                l.push(r = [])),
                n = !1,
                (i = G.exec(o)) && (n = i.shift(),
                r.push({
                    value: n,
                    type: i[0].replace(F, " ")
                }),
                o = o.slice(n.length)),
                a.filter)
                    !(i = Y[s].exec(o)) || d[s] && !(i = d[s](i)) || (n = i.shift(),
                    r.push({
                        value: n,
                        type: s,
                        matches: i
        ...
        o = oe.compile = function(e, t) {
            var n, i, r, o, l, u, c = [], h = [], m = k[e + " "];
            if (!m) {
                for (t || (t = s(e)),
                n = t.length; n--; )
                    (m = Ee(t[n]))[w] ? c.push(m) : h.push(m);
                (m = k(e, (i = h,
                o = 0 < (r = c).length,
                l = 0 < i.length,
                u = function(e, t, n, s, u) {
                    var c, h, m, g = 0, y = "0", b = e && [], w = [], x = d, T = e || l && a.find.TAG("*", u), E = C += null == x ? 1 : Math.random() || .1, S = T.length;
                    for (u && (d = t == f || t || u); y !== S && null != (c = T[y]); y++) {
                        if (l && c) {
                            for (h = 0,
                            t || c.ownerDocument == f || (p(c),
                            n = !v); m = i[h++]; )
                                if (m(c, t || f, n)) {
                                    s.push(c);
                                    break
                    ...
                    o && y !== g) {
                        ...
                        if (e) {
                            if (0 < g)
                                for (; y--; )
                                    b[y] || w[y] || (w[y] = A.call(s));
                            w = Ce(w)
                        }
                        D.apply(s, w),
                        u && !e && 0 < w.length && 1 < g + r.length && oe.uniqueSort(s)
                    }
                    return u && (C = E,
                    d = x),
                    b
        ...
        l = oe.select = function(e, t, n, i) {
            var r, l, d, u, c, p = "function" == typeof e && e, f = !i && s(e = p.selector || e);
            if (n = n || [],
            1 === f.length) {
                if (2 < (l = f[0] = f[0].slice(0)).length && "ID" === (d = l[0]).type && 9 === t.nodeType && v && a.relative[l[1].type]) {
                    if (!(t = (a.find.ID(d.matches[0].replace(te, ne), t) || [])[0]))
                        return n;
                    p && (t = t.parentNode),
                ...
                !a.relative[u = d.type]); )
                    if ((c = a.find[u]) && (i = c(d.matches[0].replace(te, ne), ee.test(l[0].type) && ge(t.parentNode) || t))) {
                        if (l.splice(r, 1),
                        !(e = i.length && be(l)))
                            return D.apply(n, i),
                            n;
            ...
            return (p || o(e, f))(i, t, !v, n, !t || ee.test(e) && ge(t.parentNode) || t),
            n
        }
        ,
    ...
    var $ = /^<([a-z][^\/\0>:\x20\t\r\n\f]*)[\x20\t\r\n\f]*\/?>(?:<\/\1>|)$/i;
    function P(e, t, n) {
        return h(t) ? x.grep(e, (function(e, a) {
    ...
    x.filter = function(e, t, n) {
        var a = t[0];
        return n && (e = ":not(" + e + ")"),
        1 === t.length && 1 === a.nodeType ? x.find.matchesSelector(a, e) ? [a] : [] : x.find.matches(e, x.grep(t, (function(e) {
            return 1 === e.nodeType
        }
        )))
    }
    ...
    (x.fn.init = function(e, t, n) {
        ...
        if (n = n || L,
        "string" == typeof e) {
            if (!(a = "<" === e[0] && ">" === e[e.length - 1] && 3 <= e.length ? [null, e, null] : A.exec(e)) || !a[1] && t)
                return !t || t.jquery ? (t || n).find(e) : this.constructor(t).find(e);
            if (a[1]) {
                if (t = t instanceof x ? t[0] : t,
                x.merge(this, x.parseHTML(a[1], t && t.nodeType ? t.ownerDocument || t : m, !0)),
                $.test(a[1]) && x.isPlainObject(t))
                    for (a in t)
                        h(this[a]) ? this[a](t[a]) : this.attr(a, t[a]);
                return this
            }
            return (i = m.getElementById(a[2])) && (this[0] = i,
            this.length = 1),
            this
        }
    ...
    x.fn.extend({
        ...
        closest: function(e, t) {
            var n, a = 0, i = this.length, r = [], s = "string" != typeof e && x(e);
            if (!k.test(e))
                for (; a < i; a++)
    ...
    x.each({
        ...
        contents: function(e) {
            return null != e.contentDocument && a(e.contentDocument) ? e.contentDocument : (M(e, "template") && (e = e.content || e),
        ...
        x.fn[e] = function(n, a) {
            ...
            a && "string" == typeof a && (i = x.filter(a, i)),
            1 < this.length && (D[e] || x.uniqueSort(i),
            z.test(e) && i.reverse()),
            this.pushStack(i)
        }
    }
    ...
    x.Callbacks = function(e) {
        ...
        n) : x.extend({}, e);
        var a, i, r, s, o = [], l = [], d = -1, u = function() {
            for (s = s || e.once,
            r = a = !0; l.length; d = -1)
                for (i = l.shift(); ++d < o.length; )
                    !1 === o[d].apply(i[0], i[1]) && e.stopOnFalse && (d = o.length,
                    i = !1);
            e.memory || (i = !1),
            a = !1,
            s && (o = i ? [] : "")
            ...
            add: function() {
                return o && (i && !a && (d = o.length - 1,
                l.push(i)),
                function t(n) {
                    x.each(n, (function(n, a) {
                        h(a) ? e.unique && c.has(a) || o.push(a) : a && a.length && "string" !== b(a) && t(a)
                    }
                    ))
                }(arguments),
                i && !a && u()),
    ...
    x.extend({
                        ...
                        return function() {
                            var o = this
                              ...
                              , d = function() {
                                var e, d;
                                if (!(t < r)) {
                                    if ((e = a.apply(o, l)) === n.promise())
                                        throw new TypeError("Thenable self-resolution");
                                    d = e && ("object" == typeof e || "function" == typeof e) && e.then,
                                    h(d) ? i ? d.call(e, s(r, n, I, i), s(r, n, j, i)) : (r++,
                                    d.call(e, s(r, n, I, i), s(r, n, j, i), s(r, n, I, n.notifyWith))) : (a !== I && (o = void 0,
                                    l = [e]),
                                    (i || n.resolveWith)(o, l))
                                }
                            }
        ...
        when: function(e) {
            ...
            if (t <= 1 && (H(e, s.done(o(n)).resolve, s.reject, !t),
    ...
    x.ready.then = q.then,
    "complete" === m.readyState || "loading" !== m.readyState && !m.documentElement.doScroll ? e.setTimeout(x.ready) : (m.addEventListener("DOMContentLoaded", R),
    e.addEventListener("load", R));
    var F = function(e, t, n, a, i, r, s) {
        var o = 0
          , l = e.length
          , d = null == n;
        if ("object" === b(n))
    ...
    function X(e) {
        return e.replace(_, "ms-").replace(G, W)
    }
    var V = function(e) {
    ...
    Y.prototype = {
        ...
        remove: function(e, t) {
            ...
            if (void 0 !== a) {
                if (void 0 !== t) {
                    n = (t = Array.isArray(t) ? t.map(X) : (t = X(t))in a ? [t] : t.match(O) || []).length;
                    for (; n--; )
                        delete a[t[n]]
                }
    ...
    function Z(e, t, n) {
        ...
        if (void 0 === n && 1 === e.nodeType)
            if (a = "data-" + t.replace(J, "-$&").toLowerCase(),
    ...
    x.fn.extend({
        data: function(e, t) {
            var n, a, i, r = this[0], s = r && r.attributes;
            if (void 0 === e) {
                if (this.length && (i = K.get(r),
                1 === r.nodeType && !U.get(r, "hasDataAttrs"))) {
                    for (n = s.length; n--; )
                        s[n] && 0 === (a = s[n].name).indexOf("data-") && (a = X(a.slice(5)),
                        Z(r, a, i[a]));
    ...
    x.extend({
        queue: function(e, t, n) {
            ...
            if (e)
                return t = (t || "fx") + "queue",
                a = U.get(e, t),
                n && (!a || Array.isArray(n) ? a = U.access(e, t, x.makeArray(n)) : a.push(n)),
                a || []
        },
    ...
    x.fn.extend({
        ...
        promise: function(e, t) {
            var n, a = 1, i = x.Deferred(), r = this, s = this.length, o = function() {
                --a || i.resolveWith(r, [r])
            };
            for ("string" != typeof e && (t = e,
            e = void 0),
            e = e || "fx"; s--; )
                (n = U.get(r[s], e + "queueHooks")) && n.empty && (a++,
                n.empty.add(o));
            return o(),
            i.promise(t)
        }
    ...
    function oe(e, t, n, a) {
        var i, r, s = 20, o = a ? function() {
            return a.cur()
        }
        : function() {
            return x.css(e, t, "")
        }
        , l = o(), d = n && n[3] || (x.cssNumber[t] ? "" : "px"), u = e.nodeType && (x.cssNumber[t] || "px" !== d && +l) && te.exec(x.css(e, t));
        if (u && u[3] !== d) {
            for (l /= 2,
            d = d || u[3],
            u = +l || 1; s--; )
    ...
    var le = {};
    function de(e, t) {
        for (var n, a, i, r, s, o, l, d = [], u = 0, c = e.length; u < c; u++)
            (a = e[u]).style && (n = a.style.display,
            t ? ("none" === n && (d[u] = U.get(a, "display") || null,
            d[u] || (a.style.display = "")),
            "" === a.style.display && se(a) && (d[u] = (l = s = r = void 0,
            s = (i = a).ownerDocument,
            o = i.nodeName,
            (l = le[o]) || (r = s.body.appendChild(s.createElement(o)),
            l = x.css(r, "display"),
            r.parentNode.removeChild(r),
            "none" === l && (l = "block"),
            le[o] = l)))) : "none" !== n && (d[u] = "none",
            U.set(a, "display", n)));
        for (u = 0; u < c; u++)
    ...
    var ue, ce, pe = /^(?:checkbox|radio)$/i, fe = /<([a-z][^\/\0>\x20\t\r\n\f]*)/i, he = /^$|^module$|\/(?:java|ecma)script/i;
    ...
    function be(e, t, n, a, i) {
        ...
        for (c.textContent = "",
        f = 0; r = p[f++]; )
            if (a && -1 < x.inArray(r, a))
                i && i.push(r);
            else if (d = ie(r),
            s = me(c.appendChild(r), "script"),
            d && ge(s),
            n)
                for (u = 0; r = s[u++]; )
        ...
        x.event.add(e, t, {
            ...
            handler: function(e) {
                ...
                if (1 & e.isTrigger && this[t]) {
                    ...
                    a = n(this, t),
                    this[t](),
                    s !== (r = U.get(this, t)) || a ? U.set(this, t, !1) : r = {},
                    s !== r)
                        return e.stopImmediatePropagation(),
                        e.preventDefault(),
                        r && r.value
                } else
                    s.length && (U.set(this, t, {
    ...
    x.event = {
        ...
        add: function(e, t, n, a, i) {
            var r, s, o, l, d, u, c, p, f, h, v, m = U.get(e);
            if (V(e))
                for (n.handler && (n = (r = n).handler,
                i = r.selector),
                i && x.find.matchesSelector(ae, i),
                ...
                d = (t = (t || "").match(O) || [""]).length; d--; )
                    ...
                    c.setup && !1 !== c.setup.call(e, a, h, s) || e.addEventListener && e.addEventListener(f, s)),
        ...
        remove: function(e, t, n, a, i) {
            var r, s, o, l, d, u, c, p, f, h, v, m = U.hasData(e) && U.get(e);
            if (m && (l = m.events)) {
                for (d = (t = (t || "").match(O) || [""]).length; d--; )
                    if (f = v = (o = we.exec(t[d]) || [])[1],
                    h = (o[2] || "").split(".").sort(),
                    f) {
                        for (c = x.event.special[f] || {},
                        p = l[f = (a ? c.delegateType : c.bindType) || f] || [],
                        o = o[2] && new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)"),
                        s = r = p.length; r--; )
                            u = p[r],
                            !i && v !== u.origType || n && n.guid !== u.guid || o && !o.test(u.namespace) || a && a !== u.selector && ("**" !== a || !u.selector) || (p.splice(r, 1),
                        ...
                        for (f in l)
                            x.event.remove(e, f + t[d], n, a, !0);
                x.isEmptyObject(l) && U.remove(e, "handle events")
            }
        },
        dispatch: function(e) {
            var t, n, a, i, r, s, o = new Array(arguments.length), l = x.event.fix(e), d = (U.get(this, "events") || Object.create(null))[l.type] || [], u = x.event.special[l.type] || {};
            for (o[0] = l,
            t = 1; t < arguments.length; t++)
                o[t] = arguments[t];
            if (l.delegateTarget = this,
            !u.preDispatch || !1 !== u.preDispatch.call(this, l)) {
                for (s = x.event.handlers.call(this, l, d),
                t = 0; (i = s[t++]) && !l.isPropagationStopped(); )
                    ...
                    n = 0; (r = i.handlers[n++]) && !l.isImmediatePropagationStopped(); )
                        ...
                        l.data = r.data,
                        void 0 !== (a = ((x.event.special[r.origType] || {}).handle || r.handler).apply(i.elem, o)) && !1 === (l.result = a) && (l.preventDefault(),
                        l.stopPropagation()));
        ...
        handlers: function(e, t) {
            var n, a, i, r, s, o = [], l = t.delegateCount, d = e.target;
            if (l && d.nodeType && !("click" === e.type && 1 <= e.button))
                for (; d !== this; d = d.parentNode || this)
                    if (1 === d.nodeType && ("click" !== e.type || !0 !== d.disabled)) {
                        ...
                        s = {},
                        n = 0; n < l; n++)
                            void 0 === s[i = (a = t[n]).selector + " "] && (s[i] = a.needsContext ? -1 < x(i, this).index(d) : x.find(i, this, null, [d]).length),
                            s[i] && r.push(a);
                        r.length && o.push({
                            elem: d,
                            handlers: r
        ...
        special: {
            ...
            click: {
                setup: function(e) {
                    var t = this || e;
                    return pe.test(t.type) && t.click && M(t, "input") && Se(t, "click", xe),
                    !1
                },
                trigger: function(e) {
                    var t = this || e;
                    return pe.test(t.type) && t.click && M(t, "input") && Se(t, "click"),
                    !0
                },
                _default: function(e) {
                    var t = e.target;
    ...
    x.each({
        ...
        x.event.special[e] = {
            ...
            bindType: t,
            handle: function(e) {
                var n, a = e.relatedTarget, i = e.handleObj;
                return a && (a === this || x.contains(this, a)) || (e.type = i.origType,
    ...
    x.fn.extend({
        on: function(e, t, n, a) {
            return Ee(this, e, t, n, a)
        },
        one: function(e, t, n, a) {
            return Ee(this, e, t, n, a, 1)
        },
        off: function(e, t, n) {
            var a, i;
            if (e && e.preventDefault && e.handleObj)
                return a = e.handleObj,
                x(e.delegateTarget).off(a.namespace ? a.origType + "." + a.namespace : a.origType, a.selector, a.handler),
                this;
            if ("object" == typeof e) {
                for (i in e)
                    this.off(i, t, e[i]);
    ...
    function ze(e, t) {
        ...
        if (1 === t.nodeType) {
            if (U.hasData(e) && (o = U.get(e).events))
                for (i in U.remove(t, "handle events"),
                o)
                    for (n = 0,
                    a = o[i].length; n < a; n++)
                        x.event.add(t, i, o[i][n]);
    ...
    function De(e, t, n, a) {
        t = r(t);
        var i, s, o, l, d, u, c = 0, p = e.length, v = p - 1, m = t[0], g = h(m);
        if (g || 1 < p && "string" == typeof m && !f.checkClone && Me.test(m))
        ...
        if (p && (s = (i = be(t, e[0].ownerDocument, !1, e, a)).firstChild,
        1 === i.childNodes.length && (i = s),
        s || a)) {
            for (l = (o = x.map(me(i, "script"), Le)).length; c < p; c++)
                d = i,
                c !== v && (d = x.clone(d, !0, !0),
                l && x.merge(o, me(d, "script"))),
                n.call(e[c], d, c);
            if (l)
                ...
                c = 0; c < l; c++)
                    d = o[c],
                    he.test(d.type || "") && !U.access(d, "globalEval") && x.contains(u, d) && (d.src && "module" !== (d.type || "").toLowerCase() ? x._evalUrl && !d.noModule && x._evalUrl(d.src, {
    ...
    function Ne(e, t, n) {
        for (var a, i = t ? x.filter(t, e) : e, r = 0; null != (a = i[r]); r++)
            n || 1 !== a.nodeType || x.cleanData(me(a)),
            a.parentNode && (n && ie(a) && ge(me(a, "script")),
    ...
    x.extend({
        ...
        clone: function(e, t, n) {
            var a, i, r, s, o, l, d, u = e.cloneNode(!0), c = ie(e);
            if (!(f.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || x.isXMLDoc(e)))
                for (s = me(u),
                a = 0,
                i = (r = me(e)).length; a < i; a++)
                    o = r[a],
                    "input" === (d = (l = s[a]).nodeName.toLowerCase()) && pe.test(o.type) ? l.checked = o.checked : "input" !== d && "textarea" !== d || (l.defaultValue = o.defaultValue);
            if (t)
                if (n)
                    for (r = r || me(e),
                    s = s || me(u),
                    ...
                    ze(e, u);
            return 0 < (s = me(u, "script")).length && ge(s, !c && me(e, "script")),
            u
        },
        cleanData: function(e) {
            for (var t, n, a, i = x.event.special, r = 0; void 0 !== (n = e[r]); r++)
                if (V(n)) {
                    if (t = n[U.expando]) {
                        if (t.events)
                            for (a in t.events)
                                i[a] ? x.event.remove(n, a) : x.removeEvent(n, a, t.handle);
                        n[U.expando] = void 0
                    }
        ...
        html: function(e) {
            return F(this, (function(e) {
                ...
                if (void 0 === e && 1 === t.nodeType)
                    return t.innerHTML;
                if ("string" == typeof e && !ke.test(e) && !ve[(fe.exec(e) || ["", ""])[1].toLowerCase()]) {
                    e = x.htmlPrefilter(e);
                    try {
                        for (; n < a; n++)
    ...
    x.each({
        ...
        x.fn[e] = function(e) {
            for (var n, a = [], i = x(e), r = i.length - 1, o = 0; o <= r; o++)
    ...
    function Be(e, t, n) {
        ...
        return (n = n || Ie(e)) && ("" !== (s = n.getPropertyValue(t) || n[t]) || ie(e) || (s = x.style(e, t)),
        !f.pixelBoxStyles() && Oe.test(s) && He.test(t) && (a = o.width,
        i = o.minWidth,
        r = o.maxWidth,
    ...
    !function() {
        function t() {
            if (u) {
                ...
                ae.appendChild(d).appendChild(u);
        ...
        var a, i, r, s, o, l, d = m.createElement("div"), u = m.createElement("div");
    ...
    var Re = ["Webkit", "Moz", "ms"]
      ...
      , _e = {};
    function Ge(e) {
        return x.cssProps[e] || _e[e] || (e in Fe ? e : _e[e] = function(e) {
    ...
    function Ke(e, t, n, a, i, r) {
        ...
        for (; s < 4; s += 2)
            ...
            a ? ("content" === n && (l -= x.css(e, "padding" + ne[s], !0, i)),
            "margin" !== n && (l -= x.css(e, "border" + ne[s] + "Width", !0, i))) : (l += x.css(e, "padding" + ne[s], !0, i),
            "padding" !== n ? l += x.css(e, "border" + ne[s] + "Width", !0, i) : o += x.css(e, "border" + ne[s] + "Width", !0, i));
        return !a && 0 <= r && (l += Math.max(0, Math.ceil(e["offset" + t[0].toUpperCase() + t.slice(1)] - r - l - o - .5)) || 0),
        l
    }
    function Qe(e, t, n) {
        var a = Ie(e)
          , i = (!f.boxSizingReliable() || n) && "border-box" === x.css(e, "boxSizing", !1, a)
          , r = i
          , s = Be(e, t, a)
        ...
        return (!f.boxSizingReliable() && i || !f.reliableTrDimensions() && M(e, "tr") || "auto" === s || !parseFloat(s) && "inline" === x.css(e, "display", !1, a)) && e.getClientRects().length && (i = "border-box" === x.css(e, "boxSizing", !1, a),
        (r = o in e) && (s = e[o])),
        (s = parseFloat(s) || 0) + Ke(e, t, n || (i ? "border" : "content"), r, a, s) + "px"
    }
    function Je(e, t, n, a, i) {
        return new Je.prototype.init(e,t,n,a,i)
    }
    x.extend({
        cssHooks: {
            opacity: {
        ...
        style: function(e, t, n, a) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var i, r, s, o = X(t), l = Xe.test(t), d = e.style;
                if (l || (t = Ge(o)),
                s = x.cssHooks[t] || x.cssHooks[o],
                void 0 === n)
                    return s && "get"in s && void 0 !== (i = s.get(e, !1, a)) ? i : d[t];
                "string" == (r = typeof n) && (i = te.exec(n)) && i[1] && (n = oe(e, t, i),
                r = "number"),
                null != n && n == n && ("number" !== r || l || (n += i && i[3] || (x.cssNumber[o] ? "" : "px")),
                f.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (d[t] = "inherit"),
                s && "set"in s && void 0 === (n = s.set(e, n, a)) || (l ? d.setProperty(t, n) : d[t] = n))
            }
        },
        css: function(e, t, n, a) {
            var i, r, s, o = X(t);
            return Xe.test(t) || (t = Ge(o)),
            (s = x.cssHooks[t] || x.cssHooks[o]) && "get"in s && (i = s.get(e, !0, n)),
            void 0 === i && (i = Be(e, t, a)),
    ...
    x.each(["height", "width"], (function(e, t) {
        x.cssHooks[t] = {
            get: function(e, n, a) {
                if (n)
                    return !We.test(x.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? Qe(e, t, a) : je(e, Ve, (function() {
                        return Qe(e, t, a)
                    }
                    ))
            },
            set: function(e, n, a) {
                var i, r = Ie(e), s = !f.scrollboxSize() && "absolute" === r.position, o = (s || a) && "border-box" === x.css(e, "boxSizing", !1, r), l = a ? Ke(e, t, a, o, r) : 0;
                return o && s && (l -= Math.ceil(e["offset" + t[0].toUpperCase() + t.slice(1)] - parseFloat(r[t]) - Ke(e, t, "border", !1, r) - .5)),
    ...
    x.each({
        ...
        x.cssHooks[e + t] = {
            expand: function(n) {
                for (var a = 0, i = {}, r = "string" == typeof n ? n.split(" ") : [n]; a < 4; a++)
                    i[e + ne[a] + t] = r[a] || r[a - 2] || r[0];
                return i
            }
        },
    ...
    x.fx.step = {};
    var Ze, et, tt, nt, at = /^(?:toggle|show|hide)$/, it = /queueHooks$/;
    function rt() {
        et && (!1 === m.hidden && e.requestAnimationFrame ? e.requestAnimationFrame(rt) : e.setTimeout(rt, x.fx.interval),
        x.fx.tick())
    }
    function st() {
    ...
    function ot(e, t) {
        ...
        for (t = t ? 1 : 0; a < 4; a += 2 - t)
            i["margin" + (n = ne[a])] = i["padding" + n] = e;
        return t && (i.opacity = i.width = e),
        i
    }
    function lt(e, t, n) {
        for (var a, i = (dt.tweeners[t] || []).concat(dt.tweeners["*"]), r = 0, s = i.length; r < s; r++)
            if (a = i[r].call(n, t, e))
                return a
    }
    function dt(e, t, n) {
        var a, i, r = 0, s = dt.prefilters.length, o = x.Deferred().always((function() {
            delete l.elem
        }
        )), l = function() {
            if (i)
                return !1;
            for (var t = Ze || st(), n = Math.max(0, d.startTime + d.duration - t), a = 1 - (n / d.duration || 0), r = 0, s = d.tweens.length; r < s; r++)
                d.tweens[r].run(a);
            return o.notifyWith(e, [d, a, n]),
            a < 1 && s ? n : (s || o.notifyWith(e, [d, 1, 0]),
            o.resolveWith(e, [d]),
            !1)
        }, d = o.promise({
            elem: e,
            ...
            createTween: function(t, n) {
                var a = x.Tween(e, d.opts, t, n, d.opts.specialEasing[t] || d.opts.easing);
                return d.tweens.push(a),
                a
            },
            stop: function(t) {
                var n = 0
        ...
        for (function(e, t) {
            ...
            if (a = dt.prefilters[r].call(d, e, u, d.opts))
                return h(a.stop) && (x._queueHooks(d.elem, d.opts.queue).stop = a.stop.bind(a)),
                a;
        return x.map(u, lt, d),
    ...
    x.Animation = x.extend(dt, {
        ...
        prefilters: [function(e, t, n) {
            var a, i, r, s, o, l, d, u, c = "width"in t || "height"in t, p = this, f = {}, h = e.style, v = e.nodeType && se(e), m = U.get(e, "fxshow");
            for (a in n.queue || (null == (s = x._queueHooks(e, "fx")).unqueued && (s.unqueued = 0,
            o = s.empty.fire,
            ...
            t)
                ...
                at.test(i)) {
                    ...
                    r = r || "toggle" === i,
                    i === (v ? "hide" : "show")) {
                        if ("show" !== i || !m || void 0 === m[a])
                            continue;
                        v = !0
                    }
                    f[a] = m && m[a] || x.style(e, a)
                }
            if ((l = !x.isEmptyObject(t)) || !x.isEmptyObject(f))
                for (a in c && 1 === e.nodeType && (n.overflow = [h.overflow, h.overflowX, h.overflowY],
                null == (d = m && m.display) && (d = U.get(e, "display")),
                "none" === (u = x.css(e, "display")) && (d ? u = d : (de([e], !0),
                d = e.style.display || d,
                u = x.css(e, "display"),
                de([e]))),
                ...
                l = !1,
                f)
                    l || (m ? "hidden"in m && (v = m.hidden) : m = U.access(e, "fxshow", {
                        display: d
                    }),
                    r && (m.hidden = !v),
                    v && de([e], !0),
    ...
    x.speed = function(e, t, n) {
        var a = e && "object" == typeof e ? x.extend({}, e) : {
            complete: n || !n && t || h(e) && e,
            duration: e,
            easing: n && t || t && !h(t) && t
        };
        return x.fx.off ? a.duration = 0 : "number" != typeof a.duration && (a.duration in x.fx.speeds ? a.duration = x.fx.speeds[a.duration] : a.duration = x.fx.speeds._default),
        null != a.queue && !0 !== a.queue || (a.queue = "fx"),
        a.old = a.complete,
        a.complete = function() {
            h(a.old) && a.old.call(this),
            a.queue && x.dequeue(this, a.queue)
        }
        ,
        a
    }
    ...
    x.fn.extend({
        ...
        finish: function(e) {
            return !1 !== e && (e = e || "fx"),
            this.each((function() {
                var t, n = U.get(this), a = n[e + "queue"], i = n[e + "queueHooks"], r = x.timers, s = a ? a.length : 0;
                for (n.finish = !0,
                x.queue(this, e, []),
    ...
    x.extend({
        attr: function(e, t, n) {
            ...
            if (3 !== r && 8 !== r && 2 !== r)
                return void 0 === e.getAttribute ? x.prop(e, t, n) : (1 === r && x.isXMLDoc(e) || (i = x.attrHooks[t.toLowerCase()] || (x.expr.match.bool.test(t) ? ut : void 0)),
                void 0 !== n ? null === n ? void x.removeAttr(e, t) : i && "set"in i && void 0 !== (a = i.set(e, n, t)) ? a : (e.setAttribute(t, n + ""),
                n) : i && "get"in i && null !== (a = i.get(e, t)) ? a : null == (a = x.find.attr(e, t)) ? void 0 : a)
        },
        attrHooks: {
            type: {
                set: function(e, t) {
    ...
    x.fn.extend({
            ...
            if ((t = mt(e)).length)
                for (; n = this[l++]; )
                    ...
                    a = 1 === n.nodeType && " " + ht(i) + " ") {
                        for (s = 0; r = t[s++]; )
                            a.indexOf(" " + r + " ") < 0 && (a += r + " ");
                        i !== (o = ht(a)) && n.setAttribute("class", o)
                    }
            return this
        },
        ...
        toggleClass: function(e, t) {
            ...
            return "boolean" == typeof t && a ? t ? this.addClass(e) : this.removeClass(e) : h(e) ? this.each((function(n) {
                ...
                if (a)
                    ...
                    void 0 !== e && "boolean" !== n || ((t = vt(this)) && U.set(this, "__className__", t),
        ...
        hasClass: function(e) {
            var t, n, a = 0;
            for (t = " " + e + " "; n = this[a++]; )
                if (1 === n.nodeType && -1 < (" " + ht(vt(n)) + " ").indexOf(t))
                    return !0;
            return !1
        }
    });
    ...
    x.fn.extend({
        val: function(e) {
            var t, n, a, i = this[0];
            return arguments.length ? (a = h(e),
            this.each((function(n) {
                var i;
                1 === this.nodeType && (null == (i = a ? e.call(this, n, x(this).val()) : e) ? i = "" : "number" == typeof i ? i += "" : Array.isArray(i) && (i = x.map(i, (function(e) {
                    return null == e ? "" : e + ""
                }
                ))),
    ...
    x.extend({
        valHooks: {
            ...
            select: {
                get: function(e) {
                    var t, n, a, i = e.options, r = e.selectedIndex, s = "select-one" === e.type, o = s ? null : [], l = s ? r + 1 : i.length;
                    for (a = r < 0 ? l : s ? r : 0; a < l; a++)
                        if (((n = i[a]).selected || a === r) && !n.disabled && (!n.parentNode.disabled || !M(n.parentNode, "optgroup"))) {
                            if (t = x(n).val(),
                            s)
                                return t;
                            o.push(t)
                ...
                set: function(e, t) {
                    for (var n, a, i = e.options, r = x.makeArray(t), s = i.length; s--; )
                        ((a = i[s]).selected = -1 < x.inArray(x.valHooks.option.get(a), r)) && (n = !0);
    ...
    x.extend(x.event, {
        trigger: function(t, n, a, i) {
            var r, s, o, l, d, c, p, f, g = [a || m], y = u.call(t, "type") ? t.type : t, b = u.call(t, "namespace") ? t.namespace.split(".") : [];
            if (s = f = o = a = a || m,
            3 !== a.nodeType && 8 !== a.nodeType && !yt.test(y + x.event.triggered) && (-1 < y.indexOf(".") && (y = (b = y.split(".")).shift(),
            b.sort()),
            d = y.indexOf(":") < 0 && "on" + y,
            ...
            i || !p.trigger || !1 !== p.trigger.apply(a, n))) {
                if (!i && !p.noBubble && !v(a)) {
                    ...
                    yt.test(l + y) || (s = s.parentNode); s; s = s.parentNode)
                        g.push(s),
                        o = s;
                    o === (a.ownerDocument || m) && g.push(o.defaultView || o.parentWindow || e)
                }
                for (r = 0; (s = g[r++]) && !t.isPropagationStopped(); )
                    f = s,
                    t.type = 1 < r ? l : p.bindType || y,
                    (c = (U.get(s, "events") || Object.create(null))[t.type] && U.get(s, "handle")) && c.apply(s, n),
                    (c = d && s[d]) && c.apply && V(s) && (t.result = c.apply(s, n),
                    !1 === t.result && t.preventDefault());
                return t.type = y,
                i || t.isDefaultPrevented() || p._default && !1 !== p._default.apply(g.pop(), n) || !V(a) || d && h(a[y]) && !v(a) && ((o = a[d]) && (a[d] = null),
                x.event.triggered = y,
    ...
    f.focusin || x.each({
        ...
        x.event.special[t] = {
            ...
            teardown: function() {
                var a = this.ownerDocument || this.document || this
                  , i = U.access(a, t) - 1;
                i ? U.access(a, t, i) : (a.removeEventListener(e, n, !0),
                U.remove(a, t))
            }
        }
    }
    ...
    x.parseXML = function(t) {
        ...
        return a = n && n.getElementsByTagName("parsererror")[0],
        n && !a || x.error("Invalid XML: " + (a ? x.map(a.childNodes, (function(e) {
            return e.textContent
        }
        )).join("\n") : t)),
        n
    ...
    function Mt(e, t, n, a) {
        ...
        if (Array.isArray(t))
            x.each(t, (function(t, i) {
                n || Tt.test(e) ? a(e, i) : Mt(e + "[" + ("object" == typeof i && null != i ? t : "") + "]", i, n, a)
            }
            ));
    ...
    x.fn.extend({
        ...
        serializeArray: function() {
            return this.map((function() {
                ...
                var e = this.type;
                return this.name && !x(this).is(":disabled") && kt.test(this.nodeName) && !St.test(e) && (this.checked || !pe.test(e))
            }
            )).map((function(e, t) {
                var n = x(this).val();
    ...
    function Ht(e) {
        return function(t, n) {
            "string" != typeof t && (n = t,
            t = "*");
            var a, i = 0, r = t.toLowerCase().match(O) || [];
            if (h(n))
                for (; a = r[i++]; )
                    "+" === a[0] ? (a = a.slice(1) || "*",
    ...
    function Bt(e, t, n, a) {
        ...
        function s(o) {
            ...
            x.each(e[o] || [], (function(e, o) {
                var d = o(t, n, a);
                return "string" != typeof d || r || i[d] ? r ? !(l = d) : void 0 : (t.dataTypes.unshift(d),
                s(d),
                !1)
            }
            )),
    ...
    function qt(e, t) {
        var n, a, i = x.ajaxSettings.flatOptions || {};
        for (n in t)
            void 0 !== t[n] && ((i[n] ? e : a || (a = {}))[n] = t[n]);
        return a && x.extend(!0, e, a),
        e
    }
    jt.href = wt.href,
    x.extend({
        ...
        ajax: function(t, n) {
            ...
            t = void 0),
            n = n || {};
            var a, i, r, s, o, l, d, u, c, p, f = x.ajaxSetup({}, n), h = f.context || f, v = f.context && (h.nodeType || h.jquery) ? x(h) : x.event, g = x.Deferred(), y = x.Callbacks("once memory"), b = f.statusCode || {}, w = {}, C = {}, T = "canceled", E = {
                readyState: 0,
            ...
            d)
                return E;
            for (c in (u = x.event && f.global) && 0 == x.active++ && x.event.trigger("ajaxStart"),
            ...
            f.data && (f.processData || "string" == typeof f.data) && (i += (Ct.test(i) ? "&" : "?") + f.data,
            delete f.data),
            !1 === f.cache && (i = i.replace(Lt, "$1"),
            p = (Ct.test(i) ? "&" : "?") + "_=" + xt.guid++ + p),
            f.url = i + p),
            f.ifModified && (x.lastModified[i] && E.setRequestHeader("If-Modified-Since", x.lastModified[i]),
            ...
            f.headers)
                E.setRequestHeader(c, f.headers[c]);
            ...
            a = Bt(Ot, f, n, E)) {
                ...
                d)
                    return E;
                f.async && 0 < f.timeout && (o = e.setTimeout((function() {
                    E.abort("timeout")
                }
                ), f.timeout));
                try {
            ...
            function S(t, n, s, l) {
                ...
                c = 200 <= t && t < 300 || 304 === t,
                s && (w = function(e, t, n) {
                    for (var a, i, r, s, o = e.contents, l = e.dataTypes; "*" === l[0]; )
                        l.shift(),
                ...
                !c && -1 < x.inArray("script", f.dataTypes) && x.inArray("json", f.dataTypes) < 0 && (f.converters["text script"] = function() {}
                ),
                w = function(e, t, n, a) {
                    var i, r, s, o, l, d = {}, u = e.dataTypes.slice();
                    if (u[1])
                    ...
                    for (r = u.shift(); r; )
                        ...
                        r = u.shift())
                            if ("*" === r)
                                ...
                                if (!(s = d[l + " " + r] || d["* " + r]))
                                    for (i in d)
                                        if ((o = i.split(" "))[1] === r && (s = d[l + " " + o[0]] || d["* " + o[0]])) {
                                            !0 === s ? s = d[i] : !0 !== d[i] && (r = o[0],
                                            u.unshift(o[1]));
                                            break
                                        }
                                if (!0 !== s)
                ...
                c ? (f.ifModified && ((C = E.getResponseHeader("Last-Modified")) && (x.lastModified[i] = C),
                (C = E.getResponseHeader("etag")) && (x.etag[i] = C)),
                ...
                E.status = t,
                E.statusText = (n || T) + "",
                c ? g.resolveWith(h, [p, T, E]) : g.rejectWith(h, [E, T, m]),
                E.statusCode(b),
                b = void 0,
                u && v.trigger(c ? "ajaxSuccess" : "ajaxError", [E, f, c ? p : m]),
                y.fireWith(h, [E, T]),
        ...
        if (f.cors || Ft && !t.crossDomain)
            return {
                send: function(i, r) {
                    ...
                    n = function(e) {
                        return function() {
                            n && (n = a = o.onload = o.onerror = o.onabort = o.ontimeout = o.onreadystatechange = null,
                            "abort" === e ? o.abort() : "error" === e ? "number" != typeof o.status ? r(0, "error") : r(o.status, o.statusText) : r(Rt[o.status] || o.status, o.statusText, "text" !== (o.responseType || "text") || "string" != typeof o.responseText ? {
                                binary: o.response
                            } : {
                                text: o.responseText
    ...
    x.ajaxPrefilter("json jsonp", (function(t, n, a) {
        var i, r, s, o = !1 !== t.jsonp && (Wt.test(t.url) ? "url" : "string" == typeof t.data && 0 === (t.contentType || "").indexOf("application/x-www-form-urlencoded") && Wt.test(t.data) && "data");
        if (o || "jsonp" === t.dataTypes[0])
            return i = t.jsonpCallback = h(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback,
            o ? t[o] = t[o].replace(Wt, "$1" + i) : !1 !== t.jsonp && (t.url += (Ct.test(t.url) ? "&" : "?") + t.jsonp + "=" + i),
    ...
    f.createHTMLDocument = ((_t = m.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>",
    2 === _t.childNodes.length),
    x.parseHTML = function(e, t, n) {
        return "string" != typeof e ? [] : ("boolean" == typeof t && (n = t,
        t = !1),
        t || (f.createHTMLDocument ? ((a = (t = m.implementation.createHTMLDocument("")).createElement("base")).href = m.location.href,
        t.head.appendChild(a)) : t = m),
        r = !n && [],
        (i = $.exec(e)) ? [t.createElement(i[1])] : (i = be([e], t, r),
    ...
    x.fn.load = function(e, t, n) {
        var a, i, r, s = this, o = e.indexOf(" ");
        return -1 < o && (a = ht(e.slice(o)),
        e = e.slice(0, o)),
        h(t) ? (n = t,
        ...
        0 < s.length && x.ajax({
            ...
            r = arguments,
            s.html(a ? x("<div>").append(x.parseHTML(e)).find(a) : e)
        }
    ...
    x.offset = {
        setOffset: function(e, t, n) {
            var a, i, r, s, o, l, d = x.css(e, "position"), u = x(e), c = {};
            "static" === d && (e.style.position = "relative"),
            o = u.offset(),
            r = x.css(e, "top"),
            l = x.css(e, "left"),
            ("absolute" === d || "fixed" === d) && -1 < (r + l).indexOf("auto") ? (s = (a = u.position()).top,
            i = a.left) : (s = parseFloat(r) || 0,
            i = parseFloat(l) || 0),
    ...
    x.fn.extend({
        ...
        position: function() {
            if (this[0]) {
                var e, t, n, a = this[0], i = {
                    top: 0,
                    left: 0
                };
                if ("fixed" === x.css(a, "position"))
                    t = a.getBoundingClientRect();
                else {
                    for (t = this.offset(),
                    n = a.ownerDocument,
                    e = a.offsetParent || n.documentElement; e && (e === n.body || e === n.documentElement) && "static" === x.css(e, "position"); )
                        e = e.parentNode;
                    e && e !== a && 1 === e.nodeType && ((i = x(e).offset()).top += x.css(e, "borderTopWidth", !0),
                    i.left += x.css(e, "borderLeftWidth", !0))
                }
                return {
                    top: t.top - i.top - x.css(a, "marginTop", !0),
                    left: t.left - i.left - x.css(a, "marginLeft", !0)
                }
            }
        },
        ...
        x.each({
            ...
            x.fn[a] = function(i, r) {
                ...
                return F(this, (function(t, n, i) {
                    var r;
                    return v(t) ? 0 === a.indexOf("outer") ? t["inner" + e] : t.document.documentElement["client" + e] : 9 === t.nodeType ? (r = t.documentElement,
                    Math.max(t.body["scroll" + e], r["scroll" + e], t.body["offset" + e], r["offset" + e], r["client" + e])) : void 0 === i ? x.css(t, n, o) : x.style(t, n, i, o)
                }
                ), t, s ? i : void 0, s)
            }
        }
...
jQuery(document).ready((function() {
    "use strict";
    var e, t, n = (e = $(".js-accordion").find(".js-accordion-header"),
    t = {
        speed: 400,
        oneOpen: !1
    },
    {
        init: function(a) {
            ...
            $.extend(t, a),
            t.oneOpen && $(".js-accordion-item.active").length > 1 && $(".js-accordion-item.active:not(:first)").removeClass("active"),
            $(".js-accordion-item.active").find("> .js-accordion-body").show()
        },
        toggle: function(e) {
            t.oneOpen && e[0] != e.closest(".js-accordion").find("> .js-accordion-item.active > .js-accordion-header")[0] && e.closest(".js-accordion").find("> .js-accordion-item").removeClass("active").find(".js-accordion-body").slideUp(),
            e.closest(".js-accordion-item").toggleClass("active"),
            e.next().stop().slideToggle(t.speed)
        }
    });
    n.init({
        speed: 300,
...
jQuery(document).ready((function() {
    $(window).scroll((function() {
        $(window).scrollTop() > 1 ? $("#header").addClass("scrollPage") : $("#header").removeClass("scrollPage")
    }
    )),
    $("#toCreateAGroup").click((function() {
    ...
    $(".chimeForm__wrapButtons .chimeForm__button").on("click", (function() {
        $("#popupForm .chimeForm__button").removeClass("active"),
        $(this).addClass("active")
    }
    )),
    $("#popupForm .chimeForm__wrapButtons #call-now").on("click", (function() {
        $("#popupForm .chimeForm__dateTime").slideUp(),
        $("#popupForm .chimeForm__dateTime").val("")
    }
    )),
    $("#popupForm .chimeForm__wrapButtons #call-time").on("click", (function() {
        $("#popupForm .chimeForm__dateTime").slideDown()
    }
    )),
    $(".home #topmenu").on("click", ".topmenu__link", (function(e) {
        e.preventDefault();
    ...
    $("#burger").click((function() {
        $("#topmenu, #topmenu .topmenu__list").toggleClass("open"),
        $("body").toggleClass("no-scroll")
    }
    )),
    $("#topmenu .topmenu__link").click((function() {
        $("#topmenu, #topmenu .topmenu__list").toggleClass("open"),
        $("body").toggleClass("no-scroll")
    }
    )),
    $("#appointmentBtn").click((function() {
        $(this).attr("href");
        return 0 != $("#appointment").length && $("html, body").animate({
            scrollTop: $("#appointment").offset().top
        }, 0),
        !1
    }
    )),
    $(".firstScreen__btnDown").click((function() {
        $(this).attr("href");
        return 0 != $("#about").length && $("html, body").animate({
    ...
    $(".reviews__fullReview .reviews__button").click((function() {
        $(this).parent().toggleClass("close")
    }
    )),
    $(".swiper-pagination .swiper-pagination-bullet, .reviews__wrapNavigation .swiper-button-prev, .reviews__wrapNavigation .swiper-button-next").click((function() {
        $(".reviews__fullReview").addClass("close")
    }
    )),
    $('input[type="tel"]').mask("+55(99)99999-9999"),
    $("#date").mask("99/99/9999"),
    $("#time").mask("99:99");
    let e = $("#first-name");
    function t() {
        "" == e.val() ? e.parent().addClass("empty") : e.parent().removeClass("empty"),
        e.val().length < 1 && e.parent().removeClass("number invalid"),
        e.val().length < 2 && (e.parent().removeClass("valid"),
        e.parent().addClass("invalid")),
        e.val().length > 0 && e.parent().addClass("number invalid"),
        e.val().length > 1 && (e.parent().removeClass("number invalid"),
    ...
    function a() {
        ...
        n.val().length < 1 && n.parent().removeClass("number invalid"),
        n.val().length < 2 && (n.parent().removeClass("valid"),
        n.parent().addClass("invalid")),
        n.val().length > 0 && n.parent().addClass("number invalid"),
        n.val().length > 1 && (n.parent().removeClass("number invalid"),
        n.parent().addClass("valid"))
    }
    n.blur((function() {
        a()
    }
    ...
    let i = $("#phone");
    function r() {
        "" == i.val() ? i.parent().addClass("empty") : i.parent().removeClass("empty"),
        i.val().length < 10 ? (i.parent().removeClass("valid"),
        i.parent().addClass("number invalid")) : (i.parent().removeClass("number invalid"),
        i.parent().addClass("valid"))
    }
    i.blur((function() {
        r()
    }
    ...
    let s = $("#popup-phone");
    function o() {
        "" == s.val() ? s.parent().addClass("empty") : s.parent().removeClass("empty"),
        s.val().length < 10 ? (s.parent().removeClass("valid"),
        s.parent().addClass("number invalid")) : (s.parent().removeClass("number invalid"),
    ...
    let l = /^[a-z,._,0-9]+@[a-z0-9-]+\.[a-z]{2,6}$/i
      , d = $("#email");
    function u() {
        d.parent().addClass("invalid"),
        d.val().length < 1 && (d.parent().removeClass("number"),
        d.parent().addClass("empty invalid")),
        d.val().length > 0 && (d.parent().removeClass("empty invalid"),
        d.parent().addClass("number")),
        "" != d.val() && (0 == d.val().search(l) ? (d.parent().removeClass("invalid number"),
        d.parent().addClass("valid")) : (d.parent().removeClass("valid"),
        d.parent().addClass("invalid")))
    }
    d.blur((function() {
        u()
    ...
    let c = /^[a-z,._,0-9]+@[a-z0-9-]+\.[a-z]{2,6}$/i
      , p = $("#popup-email");
    function f() {
        p.parent().addClass("invalid"),
        p.val().length < 1 && (p.parent().removeClass("number"),
        p.parent().addClass("empty invalid")),
        p.val().length > 0 && (p.parent().removeClass("empty invalid"),
        p.parent().addClass("number")),
        "" != p.val() && (0 == p.val().search(c) ? (p.parent().removeClass("invalid number"),
        p.parent().addClass("valid")) : (p.parent().removeClass("valid"),
        p.parent().addClass("invalid")))
    }
    p.blur((function() {
        f()
    ...
    let h = $("#date");
    function v() {
        "" == h.val() ? h.parent().addClass("empty") : h.parent().removeClass("empty"),
        h.val().length < 8 ? (h.parent().removeClass("valid"),
        h.parent().addClass("invalid")) : (h.parent().removeClass("invalid"),
        h.parent().addClass("valid"))
    }
    h.blur((function() {
        v()
    }
    ...
    let m = $("#time");
    function g() {
        "" == m.val() ? m.parent().addClass("empty") : m.parent().removeClass("empty"),
        m.val().length < 4 ? (m.parent().removeClass("valid"),
        m.parent().addClass("invalid")) : (m.parent().addClass("valid"),
        m.parent().removeClass("invalid"))
    }
    m.blur((function() {
        g()
    }
    ...
    let y = $("#message");
    function b() {
        "" == y.val() ? y.parent().addClass("empty") : y.parent().removeClass("empty"),
        y.val().length < 19 && y.parent().removeClass("number invalid"),
        y.val().length < 20 && (y.parent().removeClass("valid"),
        y.parent().addClass("invalid")),
        y.val().length > 0 && y.parent().addClass("number invalid"),
        y.val().length > 19 && (y.parent().removeClass("number invalid"),
        y.parent().addClass("valid"))
    }
    y.blur((function() {
        b()
    }
    ...
    $("#appointmentForm").submit((function() {
        ...
        return $.ajax({
            ...
            data: e,
            success: function(e) {
                "OK" == e ? ($("#textAfterSending").addClass("good"),
                $("#appointment .appointment__wrapField").removeClass("valid"),
                $("#appointmentForm .reset").val(""),
                setTimeout((function() {
    ...
    $(".chimeForm__submit.close").click((function() {
    ...
    $("#popupForm").submit((function() {
        ...
        return $.ajax({
            type: "POST",
            url: "/popup-feedback.php",
            data: e,
            success: function(e) {
                "OK" == e ? ($(".popup .thankBlock").removeClass("popup__content-close"),
                $(".popup .formBlock").addClass("popup__content-close"),
                $("#popupForm .chimeForm__wrapField").removeClass("valid"),
                $("#popupForm #call-now").removeClass("active"),
                $("#popupForm #call-time").addClass("active"),
                $("#popupForm .chimeForm__dateTime").slideDown(),
                $("#popupForm .reset").val("")) : result = e
            }
        }),
        !1
    }
...
function(e, t) {
    ...
    function e(e) {
        ...
        d(window, "resize", n.saveViewportOffsetT),
        d(window, "resize", n.validateT),
        d(window, "scroll", n.validateT)),
        t(e)
    }
    function t(e) {
        for (var t = e._util, a = 0; a < t.count; a++) {
            var i, r = t.elements[a], o = r;
            i = e.options;
            var l = o.getBoundingClientRect();
            i.container && m && (o = o.closest(i.containerClass)) ? i = !!n(o = o.getBoundingClientRect(), h) && n(l, {
                top: o.top - i.offset,
                right: o.right + i.offset,
                bottom: o.bottom + i.offset,
                left: o.left - i.offset
            }) : i = n(l, h),
            (i || s(r, e.options.successClass)) && (e.load(r),
    ...
    function a(e, t, n) {
        if (!s(e, n.successClass) && (t || n.loadInvisible || 0 < e.offsetWidth && 0 < e.offsetHeight))
            if (t = e.getAttribute(f) || e.getAttribute(n.src)) {
                var a = (t = t.split(n.separator))[v && 1 < t.length ? 1 : 0]
                  , l = e.getAttribute(n.srcset)
                ...
                if (p || void 0 === e.src) {
                    var m = new Image
                      ...
                      , y = function() {
                        p ? h || r(e, a, l) : e.style.backgroundImage = 'url("' + a + '")',
                        i(e, n),
                        u(m, "load", y),
                        u(m, "error", g)
                    };
                    h && (m = e,
                    c(t.getElementsByTagName("source"), (function(e) {
                        var t = n.srcset
                          , a = e.getAttribute(t);
                ...
                "video" === e.nodeName.toLowerCase() ? (c(e.getElementsByTagName("source"), (function(e) {
                    var t = n.src
                      , a = e.getAttribute(t);
    ...
    return function(n) {
        if (!document.querySelectorAll) {
            ...
            document.querySelectorAll = function(e, t, n, a, r) {
                for (r = document.all,
                t = [],
                n = (e = e.replace(/\[for\b/gi, "[htmlFor").split(",")).length; n--; ) {
                    for (i.addRule(e[n], "k:v"),
                    a = r.length; a--; )
                        r[a].currentStyle.k && t.push(r[a]);
                    i.removeRule(0)
                }
                return t
            }
        ...
        r.destroy = function() {
            var e = this._util;
            this.options.container && c(this.options.container, (function(t) {
        ...
        l(r.options.offset),
        c(r.options.breakpoints, (function(e) {
...
jQuery(document).ready((function(e) {
    ...
    new Blazy({
        success: function(t) {
            setTimeout((function() {
                var n = t.parentNode;
                n.className = n.className.replace(/\bloading\b/, ""),
                e(".b-lazy").addClass("scale")
            }
            ), 200)
        }
    })
...
function(e, t) {
        ...
        if ("string" == typeof e) {
            ...
            if (s.indexOf("<") >= 0 && s.indexOf(">") >= 0) {
                ...
                i = function(e, t) {
                    if ("string" != typeof e)
                        return [e];
                    for (var n = [], a = t.querySelectorAll(e), i = 0; i < a.length; i += 1)
                        n.push(a[i]);
                    return n
                }(e.trim(), t || a)
    ...
    var g, y, b, w = {
            ...
            function o(e) {
                ...
                if (t) {
                    ...
                    m(t).is(i))
                        ...
                        for (var a = m(t).parents(), s = 0; s < a.length; s += 1)
                            m(a[s]).is(i) && r.apply(a[s], n)
                }
            }
            function l(e) {
        ...
        off: function() {
            ...
            for (var o = a.split(" "), l = 0; l < o.length; l += 1)
                for (var d = o[l], u = 0; u < this.length; u += 1) {
                    var c = this[u]
                      , p = void 0;
                    if (!i && c.dom7Listeners ? p = c.dom7Listeners[d] : i && c.dom7LiveListeners && (p = c.dom7LiveListeners[d]),
                    p && p.length)
        ...
        trigger: function() {
            ...
            for (var i = n[0].split(" "), r = n[1], s = 0; s < i.length; s += 1)
                for (var l = i[s], d = 0; d < this.length; d += 1) {
                    var u = this[d];
                    if (e.CustomEvent) {
        ...
        find: function(e) {
            for (var t = [], n = 0; n < this.length; n += 1)
                for (var a = this[n].querySelectorAll(e), i = 0; i < a.length; i += 1)
                    t.push(a[i]);
            return m(t)
        },
        children: function(e) {
    ...
    function T(e, t) {
        void 0 === t && (t = "x");
        var n, a, i, r = o(), s = r.getComputedStyle(e, null);
        return r.WebKitCSSMatrix ? ((a = s.transform || s.webkitTransform).split(",").length > 6 && (a = a.split(", ").map((function(e) {
            return e.replace(",", ".")
        }
        )).join(", ")),
        i = new r.WebKitCSSMatrix("none" === a ? "" : a)) : n = (i = s.MozTransform || s.OTransform || s.MsTransform || s.msTransform || s.transform || s.getPropertyValue("transform").replace("translate(", "matrix(1, 0, 0, 1,")).toString().split(","),
        "x" === t && (a = r.WebKitCSSMatrix ? i.m41 : 16 === n.length ? parseFloat(n[12]) : parseFloat(n[4])),
        "y" === t && (a = r.WebKitCSSMatrix ? i.m42 : 16 === n.length ? parseFloat(n[13]) : parseFloat(n[5])),
        a || 0
    }
    function E(e) {
    ...
    function S() {
        for (var e = Object(arguments.length <= 0 ? void 0 : arguments[0]), t = 1; t < arguments.length; t += 1) {
            ...
            if (null != n)
                for (var a = Object.keys(Object(n)), i = 0, r = a.length; i < r; i += 1) {
                    var s = a[i]
                      , o = Object.getOwnPropertyDescriptor(n, s);
                    void 0 !== o && o.enumerable && (E(e[s]) && E(n[s]) ? S(e[s], n[s]) : !E(e[s]) && E(n[s]) ? (e[s] = {},
                    S(e[s], n[s])) : e[s] = n[s])
                }
        }
        return e
    ...
    function k(e, t) {
        Object.keys(t).forEach((function(n) {
            E(t[n]) && Object.keys(t[n]).forEach((function(a) {
    ...
    function $(e) {
        ...
        y || (y = function(e) {
            var t = (void 0 === e ? {} : e).userAgent
              ...
              , h = "Win32" === i
              , v = "MacIntel" === i;
            return !c && v && n.touch && ["1024x1366", "1366x1024", "834x1194", "1194x834", "834x1112", "1112x834", "768x1024", "1024x768", "820x1180", "1180x820", "810x1080", "1080x810"].indexOf(l + "x" + d) >= 0 && ((c = r.match(/(Version)\/([\d.]+)/)) || (c = [0, 1, "13_0_0"]),
            v = !1),
            u && !h && (s.os = "android",
            s.android = !0),
            (c || f || p) && (s.os = "ios",
    ...
    function D(e) {
        ...
        if (!t.animating || !s.preventInteractionOnTransition) {
            ...
            var u = m(d.target);
            if (("wrapper" !== s.touchEventsTarget || u.closest(t.wrapperEl).length) && (i.isTouchEvent = "touchstart" === d.type,
            (i.isTouchEvent || !("which"in d) || 3 !== d.which) && !(!i.isTouchEvent && "button"in d && d.button > 0 || i.isTouched && i.isMoved)))
                ...
                s.noSwiping && u.closest(s.noSwipingSelector ? s.noSwipingSelector : "." + s.noSwipingClass)[0])
                    ...
                    if (!f || !(c <= h || c >= a.innerWidth - h)) {
                        ...
                        "touchstart" !== d.type) {
                            var v = !0;
                            u.is(i.formElements) && (v = !1),
                            n.activeElement && m(n.activeElement).is(i.formElements) && n.activeElement !== u[0] && n.activeElement.blur();
        ...
        a.isTouched) {
            if (!a.isTouchEvent || "touchmove" === l.type) {
                ...
                if (a.isTouchEvent && i.touchReleaseOnEdges && !i.loop)
                    if (n.isVertical()) {
                        if (c < s.startY && n.translate <= n.maxTranslate() || c > s.startY && n.translate >= n.minTranslate())
                            return a.isTouched = !1,
                            void (a.isMoved = !1)
                    } else if (u < s.startX && n.translate <= n.maxTranslate() || u > s.startX && n.translate >= n.minTranslate())
                        return;
                if (a.isTouchEvent && t.activeElement && l.target === t.activeElement && m(l.target).is(a.formElements))
                    return a.isMoved = !0,
                    void (n.allowClick = !1);
                ...
                !(l.targetTouches && l.targetTouches.length > 1)) {
                    ...
                    if (!(n.params.threshold && Math.sqrt(Math.pow(f, 2) + Math.pow(h, 2)) < n.params.threshold))
                        if (void 0 === a.isScrolling && (n.isHorizontal() && s.currentY === s.startY || n.isVertical() && s.currentX === s.startX ? a.isScrolling = !1 : f * f + h * h >= 25 && (p = 180 * Math.atan2(Math.abs(h), Math.abs(f)) / Math.PI,
                        a.isScrolling = n.isHorizontal() ? p > i.touchAngle : 90 - p > i.touchAngle)),
                        a.isScrolling && n.emit("touchMoveOpposite", l),
                        ...
                        a.isScrolling)
                            ...
                            v > 0 && a.currentTranslate > n.minTranslate() ? (g = !1,
                            i.resistance && (a.currentTranslate = n.minTranslate() - 1 + Math.pow(-n.minTranslate() + a.startTranslate + v, y))) : v < 0 && a.currentTranslate < n.maxTranslate() && (g = !1,
                            i.resistance && (a.currentTranslate = n.maxTranslate() + 1 - Math.pow(n.maxTranslate() - a.startTranslate - v, y))),
    ...
    function O(e) {
        ...
        var u, c = C(), p = c - n.touchStartTime;
        if (t.allowClick && (t.updateClickedSlide(d),
        t.emit("tap click", d),
        p < 300 && c - n.lastClickTime < 300 && t.emit("doubleTap doubleClick", d)),
        n.lastClickTime = C(),
        x((function() {
        ...
        n.isMoved = !1,
        n.startMoving = !1,
        u = a.followFinger ? r ? t.translate : -t.translate : -n.currentTranslate,
        !a.cssMode)
            if (a.freeMode) {
                if (u < -t.minTranslate())
                ...
                if (a.freeModeMomentum) {
                    if (n.velocities.length > 1) {
                        ...
                        (m > 150 || C() - f.time > 300) && (t.velocity = 0)
                    } else
                        t.velocity = 0;
                    ...
                    var g = 1e3 * a.freeModeMomentumRatio
                      ...
                      , b = t.translate + y;
                    r && (b = -b);
                    var w, T, E = !1, S = 20 * Math.abs(t.velocity) * a.freeModeMomentumBounceRatio;
                    if (b < t.maxTranslate())
                        a.freeModeMomentumBounce ? (b + t.maxTranslate() < -S && (b = t.maxTranslate() - S),
                        w = t.maxTranslate(),
                        E = !0,
                        n.allowMomentumBounce = !0) : b = t.maxTranslate(),
                        a.loop && a.centeredSlides && (T = !0);
                    else if (b > t.minTranslate())
                        a.freeModeMomentumBounce ? (b - t.minTranslate() > S && (b = t.minTranslate() + S),
                        w = t.minTranslate(),
                        E = !0,
                    ...
                    0 !== t.velocity) {
                        ...
                        a.freeModeSticky) {
                            var $ = Math.abs((r ? -b : b) - t.translate)
                              , P = t.slidesSizesGrid[t.activeIndex];
                            g = $ < P ? a.speed : $ < 2 * P ? 1.5 * a.speed : 2.5 * a.speed
                        }
                    } else if (a.freeModeSticky)
                        return void t.slideToClosest();
                    a.freeModeMomentumBounce && E ? (t.updateProgress(w),
                    t.setTransition(g),
                    t.setTranslate(b),
                ...
                for (var L = 0, A = t.slidesSizesGrid[0], z = 0; z < o.length; z += z < a.slidesPerGroupSkip ? 1 : a.slidesPerGroup) {
                    var D = z < a.slidesPerGroupSkip - 1 ? 1 : a.slidesPerGroup;
                    void 0 !== o[z + D] ? u >= o[z] && u < o[z + D] && (L = z,
                    A = o[z + D] - o[z]) : u >= o[z] && (L = z,
                    A = o[o.length - 1] - o[o.length - 2])
                }
                var N = (u - o[L]) / A
                  , O = L < a.slidesPerGroupSkip - 1 ? 1 : a.slidesPerGroup;
                if (p > a.longSwipesMs) {
                    if (!a.longSwipes)
                        return void t.slideTo(t.activeIndex);
                    "next" === t.swipeDirection && (N >= a.longSwipesRatio ? t.slideTo(L + O) : t.slideTo(L)),
                    "prev" === t.swipeDirection && (N > 1 - a.longSwipesRatio ? t.slideTo(L + O) : t.slideTo(L))
                } else {
                    if (!a.shortSwipes)
                        return void t.slideTo(t.activeIndex);
                    !t.navigation || d.target !== t.navigation.nextEl && d.target !== t.navigation.prevEl ? ("next" === t.swipeDirection && t.slideTo(L + O),
                    "prev" === t.swipeDirection && t.slideTo(L)) : d.target === t.navigation.nextEl ? t.slideTo(L + O) : t.slideTo(L)
                }
            }
    }
    function I() {
    ...
    function H() {
        ...
        (0 === a ? 0 : (e.translate - e.minTranslate()) / a) !== e.progress && e.updateProgress(n ? -e.translate : e.translate),
    ...
    var R = {
      ...
      , F = {
        ...
        eventsEmitter: {
            ...
            off: function(e, t) {
                ...
                return n.eventsListeners ? (e.split(" ").forEach((function(e) {
                    void 0 === t ? n.eventsListeners[e] = [] : n.eventsListeners[e] && n.eventsListeners[e].forEach((function(a, i) {
        ...
        update: {
            updateSize: function() {
                var e, t, n = this, a = n.$el;
                e = void 0 !== n.params.width && null !== n.params.width ? n.params.width : a[0].clientWidth,
                t = void 0 !== n.params.height && null !== n.params.height ? n.params.height : a[0].clientHeight,
                0 === e && n.isHorizontal() || 0 === t && n.isVertical() || (e = e - parseInt(a.css("padding-left") || 0, 10) - parseInt(a.css("padding-right") || 0, 10),
            ...
            updateSlides: function() {
                ...
                if (void 0 !== i) {
                    ...
                    n.slidesPerColumn > 1 && (E = Math.floor(c / n.slidesPerColumn) === c / e.params.slidesPerColumn ? c : Math.ceil(c / n.slidesPerColumn) * n.slidesPerColumn,
                    "auto" !== n.slidesPerView && "row" === n.slidesPerColumnFill && (E = Math.max(E, n.slidesPerView * n.slidesPerColumn)));
                    for (var M, $ = n.slidesPerColumn, P = E / $, L = Math.floor(c / n.slidesPerColumn), A = 0; A < c; A += 1) {
                        k = 0;
                        var z = u.eq(A);
                        if (n.slidesPerColumn > 1) {
                            ...
                            if ("row" === n.slidesPerColumnFill && n.slidesPerGroup > 1) {
                                var I = Math.floor(A / (n.slidesPerGroup * n.slidesPerColumn))
                                  , j = A - n.slidesPerColumn * n.slidesPerGroup * I
                                  , H = 0 === I ? n.slidesPerGroup : Math.min(Math.ceil((c - I * $ * n.slidesPerGroup) / $), n.slidesPerGroup);
                                D = (N = j - (O = Math.floor(j / H)) * H + I * n.slidesPerGroup) + O * E / $,
                                z.css({
                                ...
                                "column" === n.slidesPerColumnFill ? (O = A - (N = Math.floor(A / $)) * $,
                                (N > L || N === L && O === $ - 1) && (O += 1) >= $ && (O = 0,
                                N += 1)) : N = A - (O = Math.floor(A / P)) * P;
                            z.css("margin-" + (e.isHorizontal() ? "top" : "left"), 0 !== O && n.spaceBetween && n.spaceBetween + "px")
                        }
                        if ("none" !== z.css("display")) {
                            if ("auto" === n.slidesPerView) {
                                ...
                                if (q && (z[0].style.transform = "none"),
                                R && (z[0].style.webkitTransform = "none"),
                                n.roundLengths)
                                    k = e.isHorizontal() ? z.outerWidth(!0) : z.outerHeight(!0);
                                else if (e.isHorizontal()) {
                                    var F = parseFloat(B.getPropertyValue("width") || 0)
                                      , _ = parseFloat(B.getPropertyValue("padding-left") || 0)
                                      , G = parseFloat(B.getPropertyValue("padding-right") || 0)
                                    ...
                                    if (te && "border-box" === te)
                                        ...
                                        var ne = z[0]
                                          , ae = ne.clientHeight;
                                        k = K + Q + J + Z + ee + (ne.offsetHeight - ae)
                                    }
                                }
                                q && (z[0].style.transform = q),
                                R && (z[0].style.webkitTransform = R),
                                n.roundLengths && (k = Math.floor(k))
                            } else
                                k = (i - (n.slidesPerView - 1) * w) / n.slidesPerView,
                                n.roundLengths && (k = Math.floor(k)),
                                u[A] && (e.isHorizontal() ? u[A].style.width = k + "px" : u[A].style.height = k + "px");
                            u[A] && (u[A].swiperSlideSize = k),
                            h.push(k),
                            n.centeredSlides ? (x = x + k / 2 + C / 2 + w,
                            0 === C && 0 !== A && (x = x - i / 2 - w),
                            0 === A && (x = x - i / 2 - w),
                            Math.abs(x) < .001 && (x = 0),
                            ...
                            (T - Math.min(e.params.slidesPerGroupSkip, T)) % e.params.slidesPerGroup == 0 && p.push(x),
                            f.push(x),
                            x = x + k + w),
                            e.virtualSize += k + w,
                            C = k,
                    ...
                    r && s && ("slide" === n.effect || "coverflow" === n.effect) && a.css({
                        width: e.virtualSize + n.spaceBetween + "px"
                    }),
                    n.setWrapperSize && (e.isHorizontal() ? a.css({
                        width: e.virtualSize + n.spaceBetween + "px"
                    }) : a.css({
                        height: e.virtualSize + n.spaceBetween + "px"
                    })),
                    n.slidesPerColumn > 1 && (e.virtualSize = (k + n.spaceBetween) * E,
                    ...
                    n.centeredSlides)) {
                        ...
                        for (var ie = 0; ie < p.length; ie += 1) {
                            var re = p[ie];
                            n.roundLengths && (re = Math.floor(re)),
                            p[ie] < e.virtualSize + p[0] && M.push(re)
                        }
                        p = M
                    }
                    if (!n.centeredSlides) {
                        ...
                        for (var se = 0; se < p.length; se += 1) {
                            var oe = p[se];
                            n.roundLengths && (oe = Math.floor(oe)),
                            p[se] <= e.virtualSize - i && M.push(oe)
                        }
                        p = M,
                        Math.floor(e.virtualSize - i) - Math.floor(p[p.length - 1]) > 1 && p.push(e.virtualSize - i)
                    }
                    if (0 === p.length && (p = [0]),
                    0 !== n.spaceBetween && (e.isHorizontal() ? r ? u.filter(v).css({
                        marginLeft: w + "px"
                    }) : u.filter(v).css({
                        marginRight: w + "px"
                    }) : u.filter(v).css({
            ...
            updateAutoHeight: function(e) {
                ...
                "auto" !== n.params.slidesPerView && n.params.slidesPerView > 1)
                    ...
                    a.push(n.slides.eq(n.activeIndex)[0]);
            ...
            updateSlidesClasses: function() {
                var e, t = this, n = t.slides, a = t.params, i = t.$wrapperEl, r = t.activeIndex, s = t.realIndex, o = t.virtual && a.virtual.enabled;
                n.removeClass(a.slideActiveClass + " " + a.slideNextClass + " " + a.slidePrevClass + " " + a.slideDuplicateActiveClass + " " + a.slideDuplicateNextClass + " " + a.slideDuplicatePrevClass),
                (e = o ? t.$wrapperEl.find("." + a.slideClass + '[data-swiper-slide-index="' + r + '"]') : n.eq(r)).addClass(a.slideActiveClass),
                a.loop && (e.hasClass(a.slideDuplicateClass) ? i.children("." + a.slideClass + ":not(." + a.slideDuplicateClass + ')[data-swiper-slide-index="' + s + '"]').addClass(a.slideDuplicateActiveClass) : i.children("." + a.slideClass + "." + a.slideDuplicateClass + '[data-swiper-slide-index="' + s + '"]').addClass(a.slideDuplicateActiveClass));
            ...
            updateActiveIndex: function(e) {
                var t, n = this, a = n.rtlTranslate ? n.translate : -n.translate, i = n.slidesGrid, r = n.snapGrid, s = n.params, o = n.activeIndex, l = n.realIndex, d = n.snapIndex, u = e;
                if (void 0 === u) {
            ...
            updateClickedSlide: function(e) {
                ...
                t.clickedSlide = a,
                t.virtual && t.params.virtual.enabled ? t.clickedIndex = parseInt(m(a).attr("data-swiper-slide-index"), 10) : t.clickedIndex = m(a).index(),
        ...
        translate: {
            ...
            setTranslate: function(e, t) {
                ...
                d = Math.floor(d)),
                i.cssMode ? s[n.isHorizontal() ? "scrollLeft" : "scrollTop"] = n.isHorizontal() ? -l : -d : i.virtualTranslate || r.transform("translate3d(" + l + "px, " + d + "px, 0px)"),
        ...
        transition: {
            ...
            transitionStart: function(e, t) {
                ...
                if (!i.cssMode) {
                    ...
                    var s = t;
                    if (s || (s = a > r ? "next" : a < r ? "prev" : "reset"),
            ...
            transitionEnd: function(e, t) {
                ...
                !r.cssMode) {
                    n.setTransition(0);
                    var s = t;
                    if (s || (s = a > i ? "next" : a < i ? "prev" : "reset"),
        ...
        slide: {
            slideTo: function(e, t, n, a) {
                ...
                p && -g === r.translate || !p && g === r.translate)
                    ...
                    !1;
                if (o.cssMode) {
                    var b, w = r.isHorizontal(), x = -g;
                    return p && (x = f.scrollWidth - f.offsetWidth - x),
                    0 === t ? f[w ? "scrollLeft" : "scrollTop"] = x : f.scrollTo ? f.scrollTo(((b = {})[w ? "left" : "top"] = x,
                    b.behavior = "smooth",
                    b)) : f[w ? "scrollLeft" : "scrollTop"] = x,
                    !0
                }
                return 0 === t ? (r.setTransition(0),
                r.setTranslate(g),
                ...
                r.transitionEnd(n, m)) : (r.setTransition(t),
                r.setTranslate(g),
                r.updateActiveIndex(s),
                r.updateSlidesClasses(),
                r.emit("beforeTransitionStart", t, a),
            ...
            slidePrev: function(e, t, n) {
                ...
                var u, c = d(l ? a.translate : -a.translate), p = s.map((function(e) {
                    return d(e)
                }
                )), f = (s[p.indexOf(c)],
                s[p.indexOf(c) - 1]);
                ...
                void 0 !== f && (u = o.indexOf(f)) < 0 && (u = a.activeIndex - 1),
                a.slideTo(u, e, t, n)
            },
            ...
            slideToClosest: function(e, t, n, a) {
                ...
                if (l >= i.snapGrid[o]) {
                    var d = i.snapGrid[o];
                    l - d > (i.snapGrid[o + 1] - d) * a && (r += i.params.slidesPerGroup)
                } else {
                    var u = i.snapGrid[o - 1];
                    l - u <= (i.snapGrid[o] - u) * a && (r -= i.params.slidesPerGroup)
                }
            ...
            slideToClickedSlide: function() {
                var e, t = this, n = t.params, a = t.$wrapperEl, i = "auto" === n.slidesPerView ? t.slidesPerViewDynamic() : n.slidesPerView, r = t.clickedIndex;
                if (n.loop) {
                    if (t.animating)
                        return;
                    e = parseInt(m(t.clickedSlide).attr("data-swiper-slide-index"), 10),
                    n.centeredSlides ? r < t.loopedSlides - i / 2 || r > t.slides.length - t.loopedSlides + i / 2 ? (t.loopFix(),
                    r = a.children("." + n.slideClass + '[data-swiper-slide-index="' + e + '"]:not(.' + n.slideDuplicateClass + ")").eq(0).index(),
                    x((function() {
                        t.slideTo(r)
                    }
        ...
        loop: {
            ...
            loopFix: function() {
                ...
                var t, n = e.activeIndex, a = e.slides, i = e.loopedSlides, r = e.allowSlidePrev, s = e.allowSlideNext, o = e.snapGrid, l = e.rtlTranslate;
                e.allowSlidePrev = !0,
                e.allowSlideNext = !0;
                var d = -o[n] - e.getTranslate();
                n < i ? (t = a.length - 3 * i + n,
                t += i,
                e.slideTo(t, 0, !1, !0) && 0 !== d && e.setTranslate((l ? -e.translate : e.translate) - d)) : n >= a.length - i && (t = -a.length + n + i,
                t += i,
            ...
            attachEvents: function() {
                ...
                if (!l.touch && l.pointerEvents)
                    ...
                    if (l.touch) {
                        ...
                        i.addEventListener(a.start, e.onTouchStart, u),
                        i.addEventListener(a.move, e.onTouchMove, l.passiveListener ? {
                            passive: !1,
                            capture: d
                        } : d),
                        i.addEventListener(a.end, e.onTouchEnd, u),
                        a.cancel && i.addEventListener(a.cancel, e.onTouchEnd, u),
                        B || (t.addEventListener("touchstart", q),
                        B = !0)
                    }
                ...
                n.updateOnWindowResize ? e.on(o.ios || o.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", I, !0) : e.on("observerUpdate", I, !0)
            },
            detachEvents: function() {
                ...
                if (!l.touch && l.pointerEvents)
                    ...
                    if (l.touch) {
                        ...
                        i.removeEventListener(a.start, e.onTouchStart, u),
                        i.removeEventListener(a.move, e.onTouchMove, d),
                        i.removeEventListener(a.end, e.onTouchEnd, u),
                        a.cancel && i.removeEventListener(a.cancel, e.onTouchEnd, u)
                    }
                ...
                e.off(o.ios || o.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", I)
            }
        },
        breakpoints: {
        ...
        classes: {
            addClasses: function() {
                ...
                "column" === n.slidesPerColumnFill && s.push("multirow-column")),
        ...
        images: {
            loadImage: function(e, t, n, a, i, r) {
                ...
                m(e).parent("picture")[0] || e.complete && i ? d() : t ? ((s = new l.Image).onload = d,
                s.onerror = d,
                a && (s.sizes = a),
                n && (s.srcset = n),
                t && (s.src = t)) : d()
      ...
      , G = function() {
        function t() {
            for (var e, n, a = arguments.length, i = new Array(a), r = 0; r < a; r++)
                i[r] = arguments[r];
            1 === i.length && i[0].constructor && i[0].constructor === Object ? n = i[0] : (e = i[0],
            n = i[1]),
            n || (n = {}),
            n = S({}, n),
            e && !n.el && (n.el = e);
            ...
            if (e = l[0]) {
                ...
                var u, c, p;
                return e.swiper = s,
                e && e.shadowRoot && e.shadowRoot.querySelector ? (u = m(e.shadowRoot.querySelector("." + s.params.wrapperClass))).children = function(e) {
                    return l.children(e)
                }
                ...
                S(s, {
                    ...
                    s.support.pointerEvents && (p = ["pointerdown", "pointermove", "pointerup"]),
                    s.touchEventsTouch = {
                        start: c[0],
                        move: c[1],
                        end: c[2],
        ...
        i.changeDirection = function(e, t) {
            ...
            e === a || "horizontal" !== e && "vertical" !== e || (n.$el.removeClass("" + n.params.containerModifierClass + a).addClass("" + n.params.containerModifierClass + e),
        ...
        i.destroy = function(e, t) {
            void 0 === e && (e = !0),
            void 0 === t && (t = !0);
            var n, a = this, i = a.params, r = a.$el, s = a.$wrapperEl, o = a.slides;
    ...
    var W = {
        update: function(e) {
            ...
            r ? (g = Math.floor(a / 2) + i + l,
            y = Math.floor(a / 2) + i + o) : (g = a + (i - 1) + l,
            y = i + o);
            ...
            u === w && c === x && !e)
                return t.slidesGrid !== f && C !== v && t.slides.css(m, C + "px"),
            ...
            for (var $ = 0; $ < p.length; $ += 1)
                $ >= w && $ <= x && (void 0 === c || e ? k.push($) : ($ > c && k.push($),
                $ < u && E.push($)));
        ...
        renderSlide: function(e, t) {
            var n = this
              , a = n.params.virtual;
            if (a.cache && n.virtual.cache[t])
                return n.virtual.cache[t];
            var i = a.renderSlide ? m(a.renderSlide.call(n, e, t)) : m('<div class="' + n.params.slideClass + '" data-swiper-slide-index="' + t + '">' + e + "</div>");
            return i.attr("data-swiper-slide-index") || i.attr("data-swiper-slide-index", t),
            a.cache && (n.virtual.cache[t] = i),
            i
        },
        appendSlide: function(e) {
            var t = this;
      ...
      , V = {
        handle: function(e) {
            ...
            if (!(s.shiftKey || s.altKey || s.ctrlKey || s.metaKey || a.activeElement && a.activeElement.nodeName && ("input" === a.activeElement.nodeName.toLowerCase() || "textarea" === a.activeElement.nodeName.toLowerCase()))) {
                ...
                ((c || f) && !i || (u || p) && i) && t.slideNext(),
                ((u || p) && !i || (c || f) && i) && t.slidePrev()) : ((u || c || h || v) && (s.preventDefault ? s.preventDefault() : s.returnValue = !1),
                (c || v) && t.slideNext(),
                (u || h) && t.slidePrev()),
                t.emit("keyPress", l)
            }
      ...
      , U = {
        ...
        handle: function(e) {
            ...
            !n.mouseEntered && !i[0].contains(t.target) && !a.releaseOnEdges)
                return !0;
            ...
            n.params.freeMode) {
                ...
                if (!c) {
                    ...
                    var p = n.getTranslate() + r * a.sensitivity
                      , f = n.isBeginning
                      , h = n.isEnd;
                ...
                if (T.push(w),
                E ? (w.direction !== E.direction || w.delta > E.delta || w.time > E.time + 150) && n.mousewheel.animateSlider(w) : n.mousewheel.animateSlider(w),
        ...
        animateSlider: function(e) {
            var t = this
              , n = o();
            return !(this.params.mousewheel.thresholdDelta && e.delta < this.params.mousewheel.thresholdDelta || this.params.mousewheel.thresholdTime && C() - t.mousewheel.lastScrollTime < this.params.mousewheel.thresholdTime || !(e.delta >= 6 && C() - t.mousewheel.lastScrollTime < 60) && (e.direction < 0 ? t.isEnd && !t.params.loop || t.animating || (t.slideNext(),
      ...
      , K = {
        ...
        init: function() {
            var e, t, n = this, a = n.params.navigation;
            (a.nextEl || a.prevEl) && (a.nextEl && (e = m(a.nextEl),
            n.params.uniqueNavElements && "string" == typeof a.nextEl && e.length > 1 && 1 === n.$el.find(a.nextEl).length && (e = n.$el.find(a.nextEl))),
            a.prevEl && (t = m(a.prevEl),
            n.params.uniqueNavElements && "string" == typeof a.prevEl && t.length > 1 && 1 === n.$el.find(a.prevEl).length && (t = n.$el.find(a.prevEl))),
      ...
      , Q = {
        update: function() {
            ...
            if (n.el && e.pagination.el && e.pagination.$el && 0 !== e.pagination.$el.length) {
                var a, i = e.virtual && e.params.virtual.enabled ? e.virtual.slides.length : e.slides.length, r = e.pagination.$el, s = e.params.loop ? Math.ceil((i - 2 * e.loopedSlides) / e.params.slidesPerGroup) : e.snapGrid.length;
                ...
                "bullets" === n.type && e.pagination.bullets && e.pagination.bullets.length > 0) {
                    ...
                    r.length > 1)
                        ...
                        var c = u.eq(a)
                          , p = c.index();
                        if (c.addClass(n.bulletActiveClass),
                        n.dynamicBullets) {
                ...
                if ("fraction" === n.type && (r.find("." + n.currentClass).text(n.formatFractionCurrent(a + 1)),
                ...
                "progressbar" === n.type) {
                    ...
                    r.find("." + n.progressbarFillClass).transform("translate3d(0,0,0) scaleX(" + T + ") scaleY(" + E + ")").transition(e.params.speed)
                }
                "custom" === n.type && n.renderCustom ? (r.html(n.renderCustom(e, a + 1, s)),
      ...
      , J = {
        ...
        updateSize: function() {
            ...
            if (e.params.scrollbar.el && e.scrollbar.el) {
                ...
                n[0].style.width = "",
                n[0].style.height = "";
                var i, r = e.isHorizontal() ? a[0].offsetWidth : a[0].offsetHeight, s = e.size / e.virtualSize, o = s * (r / e.size);
                i = "auto" === e.params.scrollbar.dragSize ? r * s : parseInt(e.params.scrollbar.dragSize, 10),
        ...
        setDragPosition: function(e) {
            var t, n = this, a = n.scrollbar, i = n.rtlTranslate, r = a.$el, s = a.dragSize, o = a.trackSize, l = a.dragStartPos;
            t = (a.getPointerPosition(e) - r.offset()[n.isHorizontal() ? "left" : "top"] - (null !== l ? l : s / 2)) / (o - s),
        ...
        enableDraggable: function() {
            ...
            if (e.params.scrollbar.el) {
                ...
                o.touch ? (l.addEventListener(a.start, e.scrollbar.onDragStart, d),
                l.addEventListener(a.move, e.scrollbar.onDragMove, d),
                l.addEventListener(a.end, e.scrollbar.onDragEnd, u)) : (l.addEventListener(i.start, e.scrollbar.onDragStart, d),
                t.addEventListener(i.move, e.scrollbar.onDragMove, d),
        ...
        disableDraggable: function() {
            ...
            if (e.params.scrollbar.el) {
                ...
                o.touch ? (l.removeEventListener(a.start, e.scrollbar.onDragStart, d),
                l.removeEventListener(a.move, e.scrollbar.onDragMove, d),
                l.removeEventListener(a.end, e.scrollbar.onDragEnd, u)) : (l.removeEventListener(i.start, e.scrollbar.onDragStart, d),
                t.removeEventListener(i.move, e.scrollbar.onDragMove, d),
        ...
        init: function() {
            ...
            if (e.params.scrollbar.el) {
                var t = e.scrollbar
                  ...
                  , i = m(a.el);
                e.params.uniqueNavElements && "string" == typeof a.el && i.length > 1 && 1 === n.find(a.el).length && (i = n.find(a.el));
      ...
      , Z = {
        setTransform: function(e, t) {
            ...
            if (null == l)
                a.transform("translate3d(" + s + ", " + o + ", 0px)");
            else {
        ...
        setTranslate: function() {
            ...
            n.each((function(t, n) {
                var r = t.progress;
                e.params.slidesPerGroup > 1 && "auto" !== e.params.slidesPerView && (r += Math.ceil(n / 2) - a * (i.length - 1)),
      ...
      , ee = {
        ...
        onGestureChange: function(e) {
            ...
            r.$imageEl && 0 !== r.$imageEl.length ? (n.gestures ? i.scale = e.scale * i.currentScale : i.scale = r.scaleMove / r.scaleStart * i.currentScale,
        ...
        onGestureEnd: function(e) {
            ...
            s.$imageEl && 0 !== s.$imageEl.length && (r.scale = Math.max(Math.min(r.scale, s.maxRatio), i.minRatio),
        ...
        onTouchStart: function(e) {
            var t = this.device
              ...
              , a = n.gesture
              , i = n.image;
            a.$imageEl && 0 !== a.$imageEl.length && (i.isTouched || (t.android && e.cancelable && e.preventDefault(),
            i.isTouched = !0,
        ...
        onTouchMove: function(e) {
            ...
            i.isTouched && a.$slideEl)) {
                ...
                i.startX = T(a.$imageWrapEl[0], "x") || 0,
                i.startY = T(a.$imageWrapEl[0], "y") || 0,
                ...
                if (!(s < a.slideWidth && o < a.slideHeight)) {
                    if (i.minX = Math.min(a.slideWidth / 2 - s / 2, 0),
                    i.maxX = -i.minX,
        ...
        onTouchEnd: function() {
            ...
            if (t.$imageEl && 0 !== t.$imageEl.length) {
                ...
                0 !== a.y && (r = Math.abs((d - n.currentY) / a.y));
                var u = Math.max(i, r);
                n.currentX = o,
                n.currentY = d;
        ...
        in: function(e) {
            var t, n, a, i, r, s, o, l, d, u, c, p, f, h, v, m, g = this, y = g.zoom, b = g.params.zoom, w = y.gesture, x = y.image;
            w.$slideEl || (g.params.virtual && g.params.virtual.enabled && g.virtual ? w.$slideEl = g.$wrapperEl.children("." + g.params.slideActiveClass) : w.$slideEl = g.slides.eq(g.activeIndex),
            w.$imageEl = w.$slideEl.find("img, svg, canvas, picture, .swiper-zoom-target"),
            w.$imageWrapEl = w.$imageEl.parent("." + b.containerClass)),
            w.$imageEl && 0 !== w.$imageEl.length && (w.$slideEl.addClass("" + b.zoomedSlideClass),
            void 0 === x.touchesStart.x && e ? (t = "touchend" === e.type ? e.changedTouches[0].pageX : e.pageX,
            n = "touchend" === e.type ? e.changedTouches[0].pageY : e.pageY) : (t = x.touchesStart.x,
            n = x.touchesStart.y),
            ...
            s > h && (s = h)) : (r = 0,
            s = 0),
            w.$imageWrapEl.transition(300).transform("translate3d(" + r + "px, " + s + "px,0)"),
        ...
        toggleGestures: function(e) {
            var t = this
              ...
              , a = n.slideSelector
              , i = n.passiveListener;
            t.$wrapperEl[e]("gesturestart", a, n.onGestureStart, i),
            t.$wrapperEl[e]("gesturechange", a, n.onGestureChange, i),
            t.$wrapperEl[e]("gestureend", a, n.onGestureEnd, i)
        },
        ...
        enable: function() {
            ...
            if (!n.enabled) {
                ...
                e.$wrapperEl.on(e.touchEvents.end, e.zoom.disableGestures, a)) : "touchstart" === e.touchEvents.start && (e.$wrapperEl.on(e.touchEvents.start, r, n.onGestureStart, a),
                e.$wrapperEl.on(e.touchEvents.move, r, n.onGestureChange, i),
                e.$wrapperEl.on(e.touchEvents.end, r, n.onGestureEnd, a),
                e.touchEvents.cancel && e.$wrapperEl.on(e.touchEvents.cancel, r, n.onGestureEnd, a)),
        ...
        disable: function() {
            ...
            if (t.enabled) {
                ...
                var a = !("touchstart" !== e.touchEvents.start || !n.passiveListener || !e.params.passiveListeners) && {
                  ...
                  , r = "." + e.params.slideClass;
                n.gestures ? (e.$wrapperEl.off(e.touchEvents.start, e.zoom.enableGestures, a),
                e.$wrapperEl.off(e.touchEvents.end, e.zoom.disableGestures, a)) : "touchstart" === e.touchEvents.start && (e.$wrapperEl.off(e.touchEvents.start, r, t.onGestureStart, a),
            ...
            if (void 0 !== e && 0 !== n.slides.length) {
                ...
                0 !== r.length && r.each((function(e) {
                    ...
                    var s = r.attr("data-background")
                      ...
                      , d = r.attr("data-sizes")
                      , u = r.parent("picture");
                    n.loadImage(r[0], o || s, l, d, !1, (function() {
                        if (null != n && n && (!n || n.params) && !n.destroyed) {
                            ...
                            n.emit("lazyImageReady", i[0], r[0]),
                            n.params.autoHeight && n.updateAutoHeight()
                        }
                    }
                    )),
                    n.emit("lazyImageLoad", i[0], r[0])
                }
                ))
            }
        },
        load: function() {
            ...
            e.params.watchSlidesVisibility)
                t.children("." + n.slideVisibleClass).each((function(t) {
                    var n = r ? m(t).attr("data-swiper-slide-index") : m(t).index();
            ...
            if (s.loadPrevNext)
                if (o > 1 || s.loadPrevNextAmount && s.loadPrevNextAmount > 1) {
                    for (var c = s.loadPrevNextAmount, p = o, f = Math.min(i + p + Math.max(c, p), a.length), h = Math.max(i - Math.max(p, c), 0), v = i + o; v < f; v += 1)
        ...
        checkInViewOnLoad: function() {
            ...
            if (t && !t.destroyed) {
                var n = t.params.lazy.scrollingElement ? m(t.params.lazy.scrollingElement) : m(e)
                  ...
                  , r = a ? e.innerHeight : n[0].offsetHeight
                  , s = t.$el.offset()
                  , l = !1;
      ...
      , ne = {
        ...
        setTranslate: function(e, t) {
            var n, a, i = this, r = i.controller.control, s = i.constructor;
            function o(e) {
        ...
        setTransition: function(e, t) {
            var n, a = this, i = a.constructor, r = a.controller.control;
            function s(t) {
                t.setTransition(e, a),
      ...
      , ae = {
        ...
        init: function() {
            ...
            var a, i, r, s = e.$wrapperEl, o = s.attr("id") || "swiper-wrapper-" + e.a11y.getRandomNumber(16);
            e.a11y.addElId(s, o),
        ...
        destroy: function() {
            ...
            n.pagination && n.params.pagination.clickable && n.pagination.bullets && n.pagination.bullets.length && n.pagination.$el.off("keydown", "." + n.params.pagination.bulletClass.replace(/ /g, "."), n.a11y.onEnterKey)
        }
    }
      , ie = {
        init: function() {
            ...
            if (e.params.history) {
                ...
                var n = e.history;
                n.initialized = !0,
                n.paths = ie.getPathValues(e.params.url),
        ...
        setHistoryPopState: function() {
            var e = this;
            e.history.paths = ie.getPathValues(e.params.url),
        ...
        setHistory: function(e, t) {
            ...
            if (n.history.initialized && n.params.history.enabled) {
                var i;
                i = n.params.url ? new URL(n.params.url) : a.location;
                var r = n.slides.eq(t)
                  , s = ie.slugify(r.attr("data-history"));
                i.pathname.includes(e) || (s = e + "/" + s);
                var l = a.history.state;
                l && l.value === s || (n.params.history.replaceState ? a.history.replaceState({
                    value: s
      ...
      , le = {
        setTranslate: function() {
            var e, t = this, n = t.$el, a = t.$wrapperEl, i = t.slides, r = t.width, s = t.height, o = t.rtlTranslate, l = t.size, d = t.browser, u = t.params.cubeEffect, c = t.isHorizontal(), p = t.virtual && t.params.virtual.enabled, f = 0;
            u.shadow && (c ? (0 === (e = a.find(".swiper-cube-shadow")).length && (e = m('<div class="swiper-cube-shadow"></div>'),
            a.append(e)),
            e.css({
                height: r + "px"
            ...
            for (var h = 0; h < i.length; h += 1) {
                ...
                g % 4 == 0 ? (x = 4 * -b * l,
                T = 0) : (g - 1) % 4 == 0 ? (x = 0,
                T = 4 * -b * l) : (g - 2) % 4 == 0 ? (x = l + 4 * b * l,
                T = l) : (g - 3) % 4 == 0 && (x = -l,
                T = 3 * l + 4 * l * b),
                o && (x = -x),
                c || (C = x,
                x = 0);
                var E = "rotateX(" + (c ? 0 : -y) + "deg) rotateY(" + (c ? y : 0) + "deg) translate3d(" + x + "px, " + C + "px, " + T + "px)";
                ...
                u.slideShadows) {
                    ...
                    v.append(S)),
                    0 === k.length && (k = m('<div class="swiper-slide-shadow-' + (c ? "right" : "bottom") + '"></div>'),
                    v.append(k)),
            ...
            u.shadow)
                if (c)
                    ...
                    var M = Math.abs(f) - 90 * Math.floor(Math.abs(f) / 90)
                      ...
                      , L = u.shadowScale / $
                      , A = u.shadowOffset;
                    e.transform("scale3d(" + P + ", 1, " + L + ") translate3d(0px, " + (s / 2 + A) + "px, " + -s / 2 / L + "px) rotateX(-90deg)")
                }
            var z = d.isSafari || d.isWebView ? -l / 2 : 0;
            a.transform("translate3d(0px,0," + z + "px) rotateX(" + (t.isHorizontal() ? 0 : f) + "deg) rotateY(" + (t.isHorizontal() ? -f : 0) + "deg)")
        },
        setTransition: function(e) {
            var t = this
              , n = t.$el;
      ...
      , de = {
        setTranslate: function() {
            for (var e = this, t = e.slides, n = e.rtlTranslate, a = 0; a < t.length; a += 1) {
                var i = t.eq(a)
                  , r = i[0].progress;
                e.params.flipEffect.limitRotation && (r = Math.max(Math.min(i[0].progress, 1), -1));
                var s = -180 * r
                  , o = 0
                  , l = -i[0].swiperSlideOffset
                  , d = 0;
                if (e.isHorizontal() ? n && (s = -s) : (d = l,
                l = 0,
                o = -s,
                s = 0),
                i[0].style.zIndex = -Math.abs(Math.round(r)) + t.length,
      ...
      , ue = {
        setTranslate: function() {
            for (var e = this, t = e.width, n = e.height, a = e.slides, i = e.slidesSizesGrid, r = e.params.coverflowEffect, s = e.isHorizontal(), o = e.translate, l = s ? t / 2 - o : n / 2 - o, d = s ? r.rotate : -r.rotate, u = r.depth, c = 0, p = a.length; c < p; c += 1) {
                var f = a.eq(c)
                  , h = i[c]
                ...
                Math.abs(y) < .001 && (y = 0),
                Math.abs(T) < .001 && (T = 0);
                var E = "translate3d(" + C + "px," + x + "px," + b + "px)  rotateX(" + y + "deg) rotateY(" + g + "deg) scale(" + T + ")";
                if (f.transform(E),
                f[0].style.zIndex = 1 - Math.abs(Math.round(v)),
                r.slideShadows) {
                    var S = s ? f.find(".swiper-slide-shadow-left") : f.find(".swiper-slide-shadow-top")
                      , k = s ? f.find(".swiper-slide-shadow-right") : f.find(".swiper-slide-shadow-bottom");
                    0 === S.length && (S = m('<div class="swiper-slide-shadow-' + (s ? "left" : "top") + '"></div>'),
                    f.append(S)),
                    0 === k.length && (k = m('<div class="swiper-slide-shadow-' + (s ? "right" : "bottom") + '"></div>'),
                    f.append(k)),
      ...
      , ce = {
        init: function() {
            ...
            S(e.thumbs.swiper.params, {
                watchSlidesProgress: !0,
                slideToClickedSlide: !1
            })) : E(t.swiper) && (e.thumbs.swiper = new n(S({}, t.swiper, {
                watchSlidesVisibility: !0,
                watchSlidesProgress: !0,
                slideToClickedSlide: !1
            })),
        ...
        update: function(e) {
            ...
            if (n) {
                ...
                if (t.realIndex !== n.realIndex || r) {
                    ...
                    r && (s += "next" === o ? i : -1 * i),
                    n.visibleSlidesIndexes && n.visibleSlidesIndexes.indexOf(s) < 0 && (n.params.centeredSlides ? s = s > l ? s - Math.floor(a / 2) + 1 : s + Math.floor(a / 2) - 1 : s > l && (s = s - a + 1),
      ...
      , pe = [X, Y, {
        ...
        on: {
            ...
            click: function(e, t) {
                var n, a = e.navigation, i = a.$nextEl, r = a.$prevEl;
                !e.params.navigation.hideOnClick || m(t.target).is(r) || m(t.target).is(i) || (i ? n = i.hasClass(e.params.navigation.hiddenClass) : r && (n = r.hasClass(e.params.navigation.hiddenClass)),
...
function(e) {
    ...
    }() + ".mask", a = navigator.userAgent, i = /iphone/i.test(a), r = /android/i.test(a);
    e.mask = {
        definitions: {
            9: "[0-9]",
            a: "[A-Za-z]",
    ...
    e.fn.extend({
        ...
        mask: function(a, s) {
            ...
            d = c = a.length,
            u = null,
            e.each(a.split(""), (function(e, t) {
                "?" == t ? (c--,
                d = e) : o[t] ? (l.push(RegExp(o[t])),
            ...
            this.trigger("unmask").each((function() {
                ...
                function f(e, t) {
                    ...
                    if (!(0 > e)) {
                        ...
                        v(),
                        g.caret(Math.max(u, e))
                    }
                }
                function h(e, t) {
                    var n;
                    for (n = e; t > n && c > n; n++)
                        l[n] && (y[n] = s.placeholder)
                }
                function v() {
                    g.val(y.join(""))
                }
                function m(e) {
                    ...
                    pos = 0; c > t; t++)
                        if (l[t]) {
                            for (y[t] = s.placeholder; pos++ < a.length; )
                                if (n = a.charAt(pos - 1),
                                l[t].test(n)) {
                                    y[t] = n,
                                    i = t;
                            ...
                            y[t] === a.charAt(pos) && t !== d && (pos++,
                            i = t);
                    return e ? v() : d > i + 1 ? (g.val(""),
                    h(0, c)) : (v(),
                    g.val(g.val().substring(0, i + 1))),
                    d ? t : u
                }
                var g = e(this)
                  , y = e.map(a.split(""), (function(e) {
                ...
                g.attr("readonly") || g.one("unmask", (function() {
                    ...
                    t = setTimeout((function() {
                        v(),
                        e == a.length ? g.caret(0, e) : g.caret(e)
                    }
                    ), 10)
                }
                    ...
                    var t, n, a, r = e.which;
                    8 === r || 46 === r || i && 127 === r ? (n = (t = g.caret()).begin,
                    0 == (a = t.end) - n && (n = 46 !== r ? function(e) {
                        for (; --e >= 0 && !l[e]; )
                            ;
                        return e
                    }(n) : a = p(n - 1),
                    ...
                    h(n, a),
                    f(n, a - 1),
                    e.preventDefault()) : 27 == r && (g.val(b),
                    g.caret(0, m()),
                    e.preventDefault())
                }
                )).bind("keypress.mask", (function(t) {
                    var n, a, i, o = t.which, d = g.caret();
                    t.ctrlKey || t.altKey || t.metaKey || 32 > o || o && (0 != d.end - d.begin && (h(d.begin, d.end),
                    f(d.begin, d.end - 1)),
                    n = p(d.begin - 1),
                    c > n && (a = String.fromCharCode(o),
                    l[n].test(a) && (function(e) {
                        var t, n, a, i;
                        for (t = e,
                        n = s.placeholder; c > t; t++)
                            if (l[t]) {
                                if (a = p(t),
                                i = y[t],
                                y[t] = n,
                    ...
                    v(),
                    i = p(n),
                    r ? setTimeout(e.proxy(e.fn.caret, g, i), 0) : g.caret(i),
                    s.completed && i >= c && s.completed.call(g))),
                    t.preventDefault())
                }
                )).bind(n, (function() {
                    setTimeout((function() {
                        var e = m(!0);
                        g.caret(e),
                        s.completed && e == g.val().length && s.completed.call(g)
                    }
                    ), 0)
                }
                )),
